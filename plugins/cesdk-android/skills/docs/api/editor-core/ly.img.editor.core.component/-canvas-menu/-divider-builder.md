...
```kotlin
@Stable
open class DividerBuilder : AbstractDividerBuilder<CanvasMenu.ItemScope>
```
...
```kotlin
open override var modifier: ScopedProperty<CanvasMenu.ItemScope, Modifier>
```

Modifier of this component. By default padding, size and background modifiers are applied.
