...
```kotlin
@Stable
open class ButtonBuilder : AbstractButtonBuilder<InspectorBar.ItemScope>
```
...
```kotlin
open override var modifier: ScopedProperty<InspectorBar.ItemScope, Modifier>
```
...
```kotlin
open override var scope: ScopedProperty<EditorScope, InspectorBar.ItemScope>
```
