...
```kotlin
@Stable
open class ButtonBuilder : AbstractButtonBuilder<NavigationBar.ItemScope>
```
...
```kotlin
open override var contentPadding: ScopedProperty<NavigationBar.ItemScope, PaddingValues>
```
...
```kotlin
open override var modifier: ScopedProperty<NavigationBar.ItemScope, Modifier>
```
