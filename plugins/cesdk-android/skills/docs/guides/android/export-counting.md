...
The CE.SDK Renderer uses the same export counting and additionally sends periodic heartbeats to track the number of active instances, as described in the [Security](./security.md) documentation.
