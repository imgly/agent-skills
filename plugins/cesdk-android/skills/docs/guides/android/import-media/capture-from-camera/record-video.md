...
dependencies {
    implementation "ly.img:engine-camera:1.82.0"
    ...
    implementation "ly.img:engine:1.82.0"
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-android-examples/tree/v1.84.0-nightly.20260921/engine-guides-using-camera)
