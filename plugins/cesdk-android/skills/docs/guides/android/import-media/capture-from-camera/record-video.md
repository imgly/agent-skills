...
dependencies {
    implementation "ly.img:engine-camera:1.79.0"
    ...
    implementation "ly.img:engine:1.79.0"
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-android-examples/tree/v1.81.0-nightly.20260810/engine-guides-using-camera)
