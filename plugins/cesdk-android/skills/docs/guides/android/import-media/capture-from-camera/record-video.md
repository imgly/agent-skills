...
dependencies {
    implementation "ly.img:engine-camera:1.81.1"
    ...
    implementation "ly.img:engine:1.81.1"
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-android-examples/tree/v1.83.0-nightly.20260904/engine-guides-using-camera)
