...
CE.SDK plugins package focused editor capabilities so you can add them to an existing configuration without rebuilding the surrounding editor experience.

Use plugins when you want to expose a reusable feature, configure where it appears in the editor UI, and keep the integration code close to the behavior it enables.
