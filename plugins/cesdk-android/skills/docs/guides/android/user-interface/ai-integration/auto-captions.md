...
**Navigation:** [Plugins](../../plugins.md) > [Auto Captions](./auto-captions.md)
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-android-examples/tree/v1.84.0-nightly.20260922/editor-guides-auto-captions-plugin)
...
```groovy
dependencies {
    implementation("ly.img:plugin-auto-captions:1.84.0-nightly.20260922")
}
```
