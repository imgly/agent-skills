...
Use the public CE.SDK Android source package path as the source of truth for built-in English labels: [sources/editor-core/src/main/res/values/strings.xml](https://github.com/imgly/cesdk-android/blob/v1.82.0-rc.2/sources/editor-core/src/main/res/values/strings.xml).
...
- English labels: [sources/editor-core/src/main/res/values/strings.xml](https://github.com/imgly/cesdk-android/blob/v1.82.0-rc.2/sources/editor-core/src/main/res/values/strings.xml)
- German labels: [sources/editor-core/src/main/res/values-de/strings.xml](https://github.com/imgly/cesdk-android/blob/v1.82.0-rc.2/sources/editor-core/src/main/res/values-de/strings.xml)
- Plugin labels: each plugin can ship its own `res/values/strings.xml`, for example [background removal](https://github.com/imgly/cesdk-android/blob/v1.82.0-rc.2/sources/plugin-background-removal/src/main/res/values/strings.xml) uses `ly_img_plugin_background_removal_dock_button`
