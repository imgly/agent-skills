...
**Navigation:** [Guides](../guides.md) > [Automate Workflows](../automation.md) > [Overview](./overview.md)
...
| --- | --- |
| Create many images from one template | [Batch Processing](./batch-processing.md) |
| Merge CSV or JSON data with a template | [Data Merge](./data-merge.md) |
| Generate platform-specific size variants | [Product Variations](./product-variations.md) |
| Resize designs for different aspect ratios | [Auto-Resize](./auto-resize.md) |
| Build scenes programmatically | [Automate Design Generation](./design-generation.md) |
| Generate multiple images per design | [Multiple Image Generation](./multi-image-generation.md) |
| Trigger automation from the editor UI | Actions |
