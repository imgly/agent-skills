...
struct BasicEditorSolution: View {
  let settings = EngineSettings(
    ...
    baseURL: URL(string: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.83.0-rc.1/assets")!,
  )
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-rc.1/editor-guides-configuration-basics)
