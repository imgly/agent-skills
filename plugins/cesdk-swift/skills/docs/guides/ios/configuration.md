...
struct BasicEditorSolution: View {
  let settings = EngineSettings(
    ...
    baseURL: URL(string: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.82.0-rc.2/assets")!,
  )
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-rc.2/editor-guides-configuration-basics)
