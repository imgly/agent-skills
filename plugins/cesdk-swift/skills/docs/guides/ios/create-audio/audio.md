...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260811/engine-guides-create-audio-audio)
...
- [CE.SDK API Reference](https://img.ly/docs/cesdk/ios/api-reference/overview-8f24e1/) — Browse the complete IMGLYEngine API surface.
...
- [Record Voiceover](./audio/record-voiceover.md) — On iOS, let users capture voiceover clips directly in the editor UI.
...
- [Record Voiceover](./audio/record-voiceover.md) - Let users capture voiceover recordings directly in the CE.SDK iOS editor using the built-in dock button, recording sheet, and inspector bar controls.
