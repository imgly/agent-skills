...
![Dynamic content example with resolved text variables, a swappable hero image, and a protected brand image.](https://img.ly/docs/cesdk/ios/create-templates/add-dynamic-content-53fad7/assets/swift-based.hero.webp)

> **Reading time:** 8 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260906/engine-guides-dynamic-content)
