...
![A certificate heading that reads "Certificate for Alex Smith" — the \{\{firstName}} and \{\{lastName}} tokens resolved to their variable values when the page rendered.](https://img.ly/docs/cesdk/ios/create-templates/add-dynamic-content/text-variables-7ecb50/assets/swift-based.hero.webp)
