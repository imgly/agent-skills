...
![A template page with the centered heading "Original Template" above the subtitle "A reusable starting point".](https://img.ly/docs/cesdk/ios/create-templates/edit-or-remove-38a8be/assets/swift-based.hero.webp)
