...
![Two video clips blending into each other in a cross-fade, halfway through the transition](https://img.ly/docs/cesdk/ios/create-video/apply-transitions-146026/assets/swift-based.hero.webp)
