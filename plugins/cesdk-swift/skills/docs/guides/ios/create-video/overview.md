...
Use this overview to decide where your Swift integration should start. Start with the [Video Editor Starter Kit](../starterkits/video-editor.md) for iOS when you need an interactive timeline UI. Use Engine APIs for automation, custom controls, template-driven output, or scene preparation that runs before the editor opens.
...
- [Video Editor Starter Kit](../starterkits/video-editor.md) — For iOS, start from the timeline UI for interactive editing.
