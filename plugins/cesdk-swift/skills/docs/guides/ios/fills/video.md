...
![Multiple blocks filled with video content — a rectangle in Cover mode, an ellipse in Contain mode, and two shared-fill rectangles — demonstrating the video fill system](https://img.ly/docs/cesdk/ios/fills/video-ec7f9f/assets/swift-based.hero.webp)
