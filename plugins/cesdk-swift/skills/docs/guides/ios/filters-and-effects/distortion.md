...
![A grid showing the same photo unaltered alongside the liquid, mirror, shifter, radial pixel, and TV glitch distortion effects](https://img.ly/docs/cesdk/ios/filters-and-effects/distortion-5b5a66/assets/swift-based.hero.webp)
