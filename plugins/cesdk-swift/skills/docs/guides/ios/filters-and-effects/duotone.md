...
![The same photo under three duotone treatments: a library preset, a custom navy-to-cream pair, and a combined adjustments-plus-duotone treatment](https://img.ly/docs/cesdk/ios/filters-and-effects/duotone-831fc5/assets/swift-based.hero.webp)
