...
**Navigation:** [Build with AI](./build-with-ai.md)
...
[Connect MCP Server](./mcp-server.md)
...
[Install Agent Skills](./agent-skills.md)
...
Looking to add AI **generation features** — image, video, audio, or text — into the editor for your own users? That's a different journey: see [AI Features](../user-interface/ai-integration.md).
...
- [MCP Server](./mcp-server.md) - Connect AI assistants to CE.SDK documentation using the Model Context Protocol (MCP) server.
- [Agent Skills](./agent-skills.md) - Install CE.SDK documentation and code generation skills for AI coding assistants.
