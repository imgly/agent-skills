...
![Screen grab of the Xcode file menu.](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/file-menu.png)

**2.** Make sure the `iOS` tab is selected, and highlight the `App` template. Click `Next`.

![Screen grab of the template chooser](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/template-chooser-ios.png)
...
![Screen grab of the naming screen](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/naming-options.png)
...
![Screen grab of the dependencies menu option](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/dependencies-menu.png)
...
![Image of the packages modal screen](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/add-package.png)
...
![Image of the list of packages](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/add-package-to-target.png)
...
**3.** In the `body` variable of `ContentView`, replace the existing code with an `Editor` that uses the `engineSettings`. Configure it as a design editor using the `.imgly.configuration` modifier. It needs to be wrapped in a navigation-capable container, which is necessary for toolbars and controls to display properly.
...
> Note: Avoid using layout containers like `VStack`, `ZStack`, or `ScrollView` as the direct parent of `Editor`. These do not provide navigation context and will result in missing toolbars or UI elements.
...
![Simulator screens running the demo app](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/hello-world.png)
...
![Import error message](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/import-error.png)
...
![Examples of build errors](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/missing-package.png)
...
![Screen shot showing the settings pane with the right imports](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/check-import.png)

If the SDK is missing, you can add it using the `+` button at the bottom of the list.

#### License Key Error at Runtime

![Modal of the error for a missing license](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/license-error.png)
...
![Simulator screen with no top controls](https://img.ly/docs/cesdk/ios/get-started/ios/new-project/swiftui-s6567y/assets/missing-controls.png)

Ensure the `Editor` is wrapped in a `NavigationView`. Do **not** place it directly in a `VStack` or as the root of the view hierarchy.
