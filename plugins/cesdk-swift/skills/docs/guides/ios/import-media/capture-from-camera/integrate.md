...
`secrets.licenseKey` comes from a small [`Secrets.swift`](https://github.com/imgly/cesdk-swift-examples/blob/v1.83.0-nightly.20260916/secrets/Secrets.swift) shim the iOS guides repository ships — substitute your own license key.
