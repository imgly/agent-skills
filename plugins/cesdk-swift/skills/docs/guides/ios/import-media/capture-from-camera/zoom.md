...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-rc.2/camera-guides-quickstart)
...
`secrets.licenseKey` comes from a small [`Secrets.swift`](https://github.com/imgly/cesdk-swift-examples/blob/v1.83.0-rc.2/secrets/Secrets.swift) shim the iOS guides repository ships — substitute your own license key. See [Integrate Mobile Camera](./integrate.md) for the full launch and result handling.
