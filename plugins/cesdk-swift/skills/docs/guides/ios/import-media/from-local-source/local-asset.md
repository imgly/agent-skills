...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260810/engine-guides-import-media-local-asset)
...
A file picker is another common way to obtain a URL — forward the picked URL to the next step. On iOS, the editor's built-in upload and photo-library flows do this for you; see the [User Upload](./user-upload.md) and [Photo Roll](./photo-roll.md) guides.
...
- [User Upload](./user-upload.md) — On iOS, let users add files through the editor's upload button.
- [Photo Roll](./photo-roll.md) — On iOS, import photos directly from the device's photo library.
