...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260825/engine-guides-import-media-from-remote-source-getty-images)
...
Registering the source makes it queryable through the Asset API but does not add it to an editor's asset library. On iOS, the [Customize Asset Library](../asset-library/customize.md) guide covers adding a source to the default library and building a fully custom one.
...
- [Customize Asset Library](../asset-library/customize.md) — Surface the source in the editor's asset panels.
