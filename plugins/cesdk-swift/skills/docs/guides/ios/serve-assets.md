...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260825/engine-guides-serve-assets)
...
[Download Assets (v1.82.0-nightly.20260825)](https://cdn.img.ly/packages/imgly/cesdk-swift/1.82.0-nightly.20260825/imgly-assets.zip)

Or download and extract it from the command line:

```bash
curl -O https://cdn.img.ly/packages/imgly/cesdk-swift/1.82.0-nightly.20260825/imgly-assets.zip
