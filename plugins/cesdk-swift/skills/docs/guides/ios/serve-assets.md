...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260904/engine-guides-serve-assets)
...
[Download Assets (v1.83.0-nightly.20260904)](https://cdn.img.ly/packages/imgly/cesdk-swift/1.83.0-nightly.20260904/imgly-assets.zip)

Or download and extract it from the command line:

```bash
curl -O https://cdn.img.ly/packages/imgly/cesdk-swift/1.83.0-nightly.20260904/imgly-assets.zip
