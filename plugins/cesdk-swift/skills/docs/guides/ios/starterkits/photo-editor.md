...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-photo-editor-ios/archive/refs/heads/v1.83.0-rc.2.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-photo-editor-ios/tree/v1.83.0-rc.2)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```bash
    git clone -b v1.83.0-rc.2 https://github.com/imgly/starterkit-photo-editor-ios.git
