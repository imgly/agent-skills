...
```swift file=@cesdk_swift_examples/starter-kits/starter-kit-apparel/StarterKit/ApparelEditorStarterKit.swift reference-only
import IMGLYEditor
import IMGLYEngine
import SwiftUI
...
```swift file=@cesdk_swift_examples/starter-kits/starter-kit-apparel/StarterKit/callbacks/OnCreate+Apparel.swift reference-only
import CoreGraphics
import Foundation
import IMGLYEditor
import IMGLYEngine
...
```swift file=@cesdk_swift_examples/starter-kits/starter-kit-apparel/StarterKit/callbacks/OnExport+Apparel.swift reference-only
import IMGLYEditor
import IMGLYEngine
...
![T-Shirt Designer starter kit screenshot](https://img.ly/docs/cesdk/ios/starterkits/t-shirt-designer-jwinqr/assets/ios.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-apparel-editor-ios/archive/refs/heads/v1.83.0-nightly.20260902.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-apparel-editor-ios/tree/v1.83.0-nightly.20260902)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```bash
    git clone -b v1.83.0-nightly.20260902 https://github.com/imgly/starterkit-apparel-editor-ios.git
  ...
  <TabItem label="Existing Project">
    ...
    2. Enter the repository URL:
       ...
       ```
    3. Select version `1.83.0-nightly.20260902` and add the `IMGLYEditor` product to your target
...
You can configure the editor based on your business logic — for example, loading a scene from a previous editing session or displaying different UI for different users. Add properties to `ApparelEditorStarterKit` and use them in the `EditorConfiguration.onCreate` callback to customize scene loading or other behavior.
...
- `CanvasMenu+Apparel.swift` — see [Canvas Menu](../user-interface/customization/canvas-menu.md) for full configuration options
- `Dock+Apparel.swift` — see [Dock](../user-interface/customization/dock.md) for full configuration options
- `InspectorBar+Apparel.swift` — see [Inspector Bar](../user-interface/customization/inspector-bar.md) for full configuration options
- `NavigationBar+Apparel.swift` — see [Navigation Bar](../user-interface/customization/navigation-bar.md) for full configuration options
