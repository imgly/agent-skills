...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-apparel-editor-ios/archive/refs/heads/v1.83.0-nightly.20260908.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-apparel-editor-ios/tree/v1.83.0-nightly.20260908)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```bash
    git clone -b v1.83.0-nightly.20260908 https://github.com/imgly/starterkit-apparel-editor-ios.git
  ...
  <TabItem label="Existing Project">
    ...
    2. Enter the repository URL:
       ...
       ```
    3. Select version `1.83.0-nightly.20260908` and add the `IMGLYEditor` product to your target
