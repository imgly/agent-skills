...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-video-editor-ios/archive/refs/heads/v1.81.0.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-video-editor-ios/tree/v1.81.0)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```bash
    git clone -b v1.81.0 https://github.com/imgly/starterkit-video-editor-ios.git
