...
![Six shape types — rectangle, ellipse, star, polygon, line, and vector path — rendered side by side with solid colors and a linear gradient](https://img.ly/docs/cesdk/ios/stickers-and-shapes/create-edit/create-shapes-64acc0/assets/swift-based.hero.webp)

> **Reading time:** 15 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260811/engine-guides-create-shapes)
