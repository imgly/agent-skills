...
**Navigation:** [Guides](../guides.md) > [Create and Edit Shapes](../shapes.md) > [Insert QR Code](./insert-qr-code.md) > [Plugins](../plugins.md) > [QR Code](./insert-qr-code.md)
...
![A QR code rendered as an image fill on a page.](https://img.ly/docs/cesdk/ios/stickers-and-shapes/insert-qr-code-b6cc53/assets/swift-based.hero.webp)
