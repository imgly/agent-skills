...
![Text auto-size example showing text blocks with auto dimensions, automatic font sizing, and clipped overflow](https://img.ly/docs/cesdk/ios/text/auto-size-5331b3/assets/swift-based.hero.webp)
...
- [Customize Fonts](./custom-fonts.md) — On iOS, load and manage custom fonts to match brand guidelines or user preferences.
