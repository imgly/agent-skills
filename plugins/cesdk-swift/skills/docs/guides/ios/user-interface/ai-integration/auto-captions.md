...
**Navigation:** [Guides](../../guides.md) > [AI Features](../ai-integration.md) > [Auto Captions](./auto-captions.md) > [Plugins](../../plugins.md) > [Auto Captions](./auto-captions.md)
...
struct AutoCaptionsPluginSolution: View {
  ...
  private static let sampleVideoURL: URL = {
    let baseURL = secrets.baseURL
      ?? URL(string: "https://cdn.img.ly/packages/imgly/cesdk-swift/1.83.0/assets")!
...
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.84.0-nightly.20260922/editor-guides-auto-captions-plugin)
