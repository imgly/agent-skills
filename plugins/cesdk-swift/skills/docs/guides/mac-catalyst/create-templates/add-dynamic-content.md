...
![Dynamic content example with resolved text variables, a swappable hero image, and a protected brand image.](https://img.ly/docs/cesdk/mac-catalyst/create-templates/add-dynamic-content-53fad7/assets/swift-based.hero.webp)
