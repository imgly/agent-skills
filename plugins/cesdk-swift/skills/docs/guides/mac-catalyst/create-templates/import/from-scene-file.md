...
![A business card template applied to a 1920×1080 page, with the template content adjusted to fit the page dimensions.](https://img.ly/docs/cesdk/mac-catalyst/create-templates/import/from-scene-file-52a01e/assets/swift-based.hero.webp)
