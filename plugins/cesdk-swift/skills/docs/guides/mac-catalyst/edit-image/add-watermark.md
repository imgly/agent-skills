...
![An image with a logo and copyright text watermark anchored to the bottom of the page, both softened by a drop shadow.](https://img.ly/docs/cesdk/mac-catalyst/edit-image/add-watermark-679de0/assets/swift-based.hero.webp)

> **Reading time:** 8 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260823/engine-guides-edit-image-add-watermark)
