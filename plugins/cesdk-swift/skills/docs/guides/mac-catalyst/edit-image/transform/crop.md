...
![Crop tool appears when a selected image allows cropping.](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/crop-f67a47/assets/ios-crop-tool-161.png)
...
![An image that has been scale cropped and rotated slightly showing the cropped and original image.](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/crop-f67a47/assets/ios-ui-crop-workflow-161.png)
...
![Image with no additional crop applied shown in crop mode](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-1.png)
...
![Image crop translated one quarter of it's width to the right](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-5.png)
...
![Image crop scaled by 1.5 with no corresponding translation adjustment](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-6.png)
...
![Image crop rotated by pi/4 or 45 degrees](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-7.png)
...
![Image cropped using the scale ratio to remain centered](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-2.png)
...
![Image cropped and rotated](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-3.png)
...
![Image rotated first and then scaled](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-4.png)
...
![Image crop flipped vertically](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/crop-example-8.png)
...
- Customize the Dock or Inspector Bar to add or replace the crop button or provide a custom preset toolbar.
