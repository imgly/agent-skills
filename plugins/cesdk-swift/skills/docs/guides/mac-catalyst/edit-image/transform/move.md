...
![Two images repositioned and grouped on a single page after switching between absolute and percentage position modes.](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/move-818dd9/assets/swift-based.hero.webp)
