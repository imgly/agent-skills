...
**Navigation:** [Guides](../../guides.md) > [Create and Edit Images](../../edit-image.md) > [Transform](../transform.md) > [Scale](./scale.md)
...
When you want to scale the image **inside** the block and leave the block dimensions unchanged, you’ll use [crop scale](./crop.md) instead.
...
![Original image and scaled image](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/scale-example-1.png)
...
![Original image placed over the scaled image, aligned on the center anchor point](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/scale-example-2.png)
...
![Allowing the engine to scale the image as you adjust the width of the block](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/scale-example-3.png)
...
![Using crop scale for the horizontal axis and adjusting the width of the block](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/scale-example-4.png)
...
![Using crop scale for the horizontal axis and using the maintainCrop property when changing the width](https://img.ly/docs/cesdk/mac-catalyst/edit-image/transform/mobile-assets/scale-example-5.png)
...
When working with templates, you can lock a block from scaling by setting its scope. The [guide on locking](../../create-templates/lock.md) provides more information.
...
- [Resize](./resize.md) for changing the size of a block’s frame.
- [Crop](./crop.md) for changing what part of the image is visible.
- [Rotate](./rotate.md) for rotating images around an anchor.
- [Flip](./flip.md) to mirror images horizontally or vertically.
- [Move](./move.md) to reposition blocks on the canvas.
