...
![A watermarked video frame with a copyright text watermark in the bottom-left corner and a semi-transparent logo watermark in the top-right corner](https://img.ly/docs/cesdk/mac-catalyst/edit-video/add-watermark-762ce6/assets/swift-based.hero.webp)
