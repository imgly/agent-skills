...
**Navigation:** [Guides](../../guides.md) > [Create and Edit Videos](../../create-video.md) > [Transform](../transform.md) > [Rotate](./rotate.md)
...
When working with an editor, it's best to modify settings in the `EditorConfiguration.onCreate` callback. When working with the engine directly, they can be set at any time.

![Rotation handle of the control gizmo enabled for a video block](https://img.ly/docs/cesdk/mac-catalyst/edit-video/transform/mobile-assets/rotate-example-1.png)
...
![Crop menu showing rotation slider and button](https://img.ly/docs/cesdk/mac-catalyst/edit-video/transform/mobile-assets/rotate-example-2.png)
