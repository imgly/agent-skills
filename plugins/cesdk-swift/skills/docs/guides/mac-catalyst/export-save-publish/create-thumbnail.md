...
![An aerial coastal photo with a dark title banner and a white "Coastal Escape" heading — the source design that the thumbnails preview.](https://img.ly/docs/cesdk/mac-catalyst/export-save-publish/create-thumbnail-749be1/assets/swift-based.hero.webp)
