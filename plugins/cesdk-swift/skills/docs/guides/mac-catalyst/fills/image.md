...
![A square graphic block filled with an aerial photograph of an ocean coastline using image fill in Cover mode](https://img.ly/docs/cesdk/mac-catalyst/fills/image-e9cb5c/assets/swift-based.hero.webp)
