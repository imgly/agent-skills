...
![An astronaut subject composited over a solid blue background after the green backdrop of the source frame was keyed out with the green screen effect](https://img.ly/docs/cesdk/mac-catalyst/filters-and-effects/chroma-key-green-screen-1e3e99/assets/swift-based.hero.webp)

> **Reading time:** 8 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260811/engine-guides-chroma-key-green-screen)
