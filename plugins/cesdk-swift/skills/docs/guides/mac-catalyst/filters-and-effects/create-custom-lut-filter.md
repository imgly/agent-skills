...
![An image block with a custom LUT color grade applied through the effect API](https://img.ly/docs/cesdk/mac-catalyst/filters-and-effects/create-custom-lut-filter-6e3f49/assets/swift-based.hero.webp)
...
1. [Download the identity LUT](https://img.ly/docs/cesdk/mac-catalyst/filters-and-effects/create-custom-lut-filter-6e3f49/content-assets/6e3f49/identity.png)
