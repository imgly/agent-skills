...
![A design reconstructed by a custom importer: a colored banner, an image, and a heading laid out on a page.](https://img.ly/docs/cesdk/mac-catalyst/import-media/create-custom-importer-0f7e16/assets/swift-based.hero.webp)

> **Reading time:** 5 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260829/engine-guides-create-custom-importer)
