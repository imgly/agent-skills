...
![A gold star shape, a happy-face emoji sticker, and a sample image laid out in a row on the canvas.](https://img.ly/docs/cesdk/mac-catalyst/import-media/default-assets-d2763d/assets/swift-based.hero.webp)

> **Reading time:** 5 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260904/engine-guides-default-assets)
...
- Customize Asset Library — On iOS, configure the asset library UI and entries.
