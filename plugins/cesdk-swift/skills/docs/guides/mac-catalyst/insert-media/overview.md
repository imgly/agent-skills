...
To control which categories and sources users see in the iOS asset panel, see Customize Asset Library for iOS.
...
- Customize Asset Library for iOS — Tailor the categories, sources, and ordering that show up in the iOS asset panel.
