...
![A 3x3 grid of shapes and stickers — rectangle, rounded rectangle, ellipse, star, hexagon, line, triangle, and two emoticon stickers.](https://img.ly/docs/cesdk/mac-catalyst/insert-media/shapes-or-stickers-20ac68/assets/swift-based.hero.webp)
