...
![The different layers CE.SDK is made of, see description below.](https://img.ly/docs/cesdk/mac-catalyst/key-concepts-21a270/layers.png)
...
When exporting complex graphics and videos, the CE.SDK Renderer can make use of GPU acceleration and video codecs on Linux server environments.
