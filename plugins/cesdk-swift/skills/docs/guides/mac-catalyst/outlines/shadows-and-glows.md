...
![A page with a white title that casts a teal drop shadow, an image with a luminous glow, and a second image combining both a drop shadow and a glow.](https://img.ly/docs/cesdk/mac-catalyst/outlines/shadows-and-glows-6610fa/assets/swift-based.hero.webp)

> **Reading time:** 8 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260826/engine-guides-shadows-and-glows)
