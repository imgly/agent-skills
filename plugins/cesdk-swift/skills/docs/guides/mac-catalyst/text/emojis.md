...
![A text block rendering "Hello World!" alongside party popper, flag, family, and waving-hand emojis using the configured Noto Color Emoji font.](https://img.ly/docs/cesdk/mac-catalyst/text/emojis-510651/assets/swift-based.hero.webp)
