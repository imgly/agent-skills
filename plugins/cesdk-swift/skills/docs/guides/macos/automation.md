...
- [Data Merge](./automation/data-merge.md) - Automatically generate personalized designs from a template by merging external data into its variables and placeholder blocks.
...
- [Automate Design Generation](./automation/design-generation.md) - Populate a reusable template from application data and export the finished design with CE.SDK.
