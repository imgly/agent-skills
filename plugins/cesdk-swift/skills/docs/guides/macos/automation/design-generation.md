...
![A personalized delivery card populated with John Doe's name and address, with the profile photo replaced and recropped to cover its frame.](https://img.ly/docs/cesdk/macos/automation/design-generation-98a99e/assets/swift-based.hero.webp)

> **Reading time:** 7 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260811/engine-guides-design-generation)
