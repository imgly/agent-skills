...
![Three graphic blocks: a brand spot color on the left, a 50 percent tint in the middle, and a stroked and shadowed block on the right.](https://img.ly/docs/cesdk/macos/colors/for-print/spot-c3a150/assets/swift-based.hero.webp)
