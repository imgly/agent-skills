...
![A template page with the centered heading "Original Template" above the subtitle "A reusable starting point".](https://img.ly/docs/cesdk/macos/create-templates/edit-or-remove-38a8be/assets/swift-based.hero.webp)

> **Reading time:** 8 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260825/engine-guides-edit-or-remove-templates)
