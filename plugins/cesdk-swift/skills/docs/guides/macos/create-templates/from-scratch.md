...
![A promotional card template with the "Summer Sale" headline above the "Up to 50% off all items" subtitle, a swappable hero image, and a "Learn More" call to action.](https://img.ly/docs/cesdk/macos/create-templates/from-scratch-663cda/assets/swift-based.hero.webp)
