...
![A business card template applied to a 1920×1080 page, with the template content adjusted to fit the page dimensions.](https://img.ly/docs/cesdk/macos/create-templates/import/from-scene-file-52a01e/assets/swift-based.hero.webp)

> **Reading time:** 6 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260901/engine-guides-import-from-scene-file)
