...
![Two video clips blending into each other in a cross-fade, halfway through the transition](https://img.ly/docs/cesdk/macos/create-video/apply-transitions-146026/assets/swift-based.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260825/engine-guides-apply-transitions)
