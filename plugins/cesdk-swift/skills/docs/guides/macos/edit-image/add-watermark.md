...
![An image with a logo and copyright text watermark anchored to the bottom of the page, both softened by a drop shadow.](https://img.ly/docs/cesdk/macos/edit-image/add-watermark-679de0/assets/swift-based.hero.webp)
