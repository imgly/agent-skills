...
![Rotation handle of the control gizmo enabled for a video block](https://img.ly/docs/cesdk/macos/edit-video/transform/mobile-assets/rotate-example-1.png)
...
![Crop menu showing rotation slider and button](https://img.ly/docs/cesdk/macos/edit-video/transform/mobile-assets/rotate-example-2.png)
