...
![Gradient fills applied to shapes using linear, radial, and conical gradients](https://img.ly/docs/cesdk/macos/fills/gradient-0ff079/assets/swift-based.hero.webp)
