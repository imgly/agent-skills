...
![Multiple blocks filled with video content — a rectangle in Cover mode, an ellipse in Contain mode, and two shared-fill rectangles — demonstrating the video fill system](https://img.ly/docs/cesdk/macos/fills/video-ec7f9f/assets/swift-based.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260906/engine-guides-fills-video)
