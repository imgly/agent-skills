...
![The same photo shown in a grid under different effects: the original, pixelization, an adjustments effect, a duotone filter, a LUT filter, and a combination of effects](https://img.ly/docs/cesdk/macos/filters-and-effects/apply-2764e4/assets/swift-based.hero.webp)

> **Reading time:** 9 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.81.0-nightly.20260809/engine-guides-using-effects)
