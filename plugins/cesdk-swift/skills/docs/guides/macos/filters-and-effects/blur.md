...
![The same photo shown in a 2x2 grid under different blur types: uniform, linear, radial, and mirrored](https://img.ly/docs/cesdk/macos/filters-and-effects/blur-71d642/assets/swift-based.hero.webp)
