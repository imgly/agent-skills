...
![A design reconstructed by a custom importer: a colored banner, an image, and a heading laid out on a page.](https://img.ly/docs/cesdk/macos/import-media/create-custom-importer-0f7e16/assets/swift-based.hero.webp)
