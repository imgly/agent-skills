...
![A photograph loaded as an editable scene, its page sized to and filled by the source image.](https://img.ly/docs/cesdk/macos/open-the-editor/from-image-ad9b5e/assets/swift-based.hero.webp)
