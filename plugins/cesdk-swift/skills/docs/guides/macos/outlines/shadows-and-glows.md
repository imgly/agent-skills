...
![A page with a white title that casts a teal drop shadow, an image with a luminous glow, and a second image combining both a drop shadow and a glow.](https://img.ly/docs/cesdk/macos/outlines/shadows-and-glows-6610fa/assets/swift-based.hero.webp)
