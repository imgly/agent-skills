...
![Six shape types — rectangle, ellipse, star, polygon, line, and vector path — rendered side by side with solid colors and a linear gradient](https://img.ly/docs/cesdk/macos/stickers-and-shapes/create-edit/create-shapes-64acc0/assets/swift-based.hero.webp)
