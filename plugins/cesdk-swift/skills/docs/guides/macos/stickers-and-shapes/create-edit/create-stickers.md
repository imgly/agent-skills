...
![Two emoticon stickers placed side by side on a page, preserving the colors of the source SVG artwork.](https://img.ly/docs/cesdk/macos/stickers-and-shapes/create-edit/create-stickers-cc46e5/assets/swift-based.hero.webp)
