...
![Text auto-size example showing text blocks with auto dimensions, automatic font sizing, and clipped overflow](https://img.ly/docs/cesdk/macos/text/auto-size-5331b3/assets/swift-based.hero.webp)
