...
![Two text blocks on a light background, one with a soft drop shadow and one with a blue stroke outline](https://img.ly/docs/cesdk/macos/text/effects-2dc9fc/assets/swift-based.hero.webp)
