...
![A text block rendering "Hello World!" alongside party popper, flag, family, and waving-hand emojis using the configured Noto Color Emoji font.](https://img.ly/docs/cesdk/macos/text/emojis-510651/assets/swift-based.hero.webp)

> **Reading time:** 5 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.83.0-nightly.20260903/engine-guides-text-with-emojis)
