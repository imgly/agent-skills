...
![A personalized greeting card generated from a template, with a photo and populated text.](https://img.ly/docs/cesdk/macos/use-templates/generate-334e15/assets/swift-based.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [View source on GitHub](https://github.com/imgly/cesdk-swift-examples/tree/v1.82.0-nightly.20260825/engine-guides-use-templates-generate)
