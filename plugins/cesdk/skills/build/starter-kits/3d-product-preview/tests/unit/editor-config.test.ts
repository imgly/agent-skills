...
describe('P3D-U10 setupPanels and setupUI', () => {
...
describe('P3D-U11 setupCanvas and setupInspectorBar', () => {
...
describe('P3D-U12 setupNavigationBar and setupSettings', () => {
  it('offers image and PDF export and drops the document settings entry', () => {
    const spy = run<CreativeEditorSDK>(setupNavigationBar);
    expect(barFor(spy, 'ly.img.navigation.bar')).toContainEqual({
...
describe('P3D-U13 the setups this kit leaves empty', () => {
  it.each([
...
describe('P3D-U14 DesignEditorConfig', () => {
...
describe('P3D-U15 the action handlers the kit registers', () => {
  function handlers() {
