...
describe('ADE-U6 the exclusion area plugin', () => {
  beforeEach(async () => {
    await initialize([]);
  });
...
describe('ADE-U6 the exclusion area plugin leaves a second run alone', () => {
...
describe('ADE-U6 the exclusion area plugin without an editor', () => {
