...
import { initAdvancedEditor } from '../../src/imgly';
...
describe('initAdvancedEditor', () => {
  ...
  it('ADE-U1 registers the fifteen asset sources in one concurrent batch', async () => {
    ...
    const done = initAdvancedEditor(cesdk);
  ...
  it('ADE-U2 restricts the upload, demo and premium asset sources', () => {
  ...
  it('ADE-U2 leaves the other asset sources unconfigured', () => {
  ...
  it('ADE-U3 appends the actions dropdown with its six entries to the navigation bar', () => {
  ...
  it('ADE-U4 puts background removal in the canvas menu with the local provider', () => {
