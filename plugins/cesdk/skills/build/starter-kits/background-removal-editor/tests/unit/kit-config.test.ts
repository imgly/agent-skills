...
describe('BGR-U3 setupNavigationBar and setupActions', () => {
...
describe('BGR-U4 setupFeatures and setupSettings', () => {
  ...
  it.each([
    ...
    'ly.img.shadow.blur',
    'ly.img.shadow.offset'
  ])('enables %s, which the background-removal flow needs', (feature) => {
