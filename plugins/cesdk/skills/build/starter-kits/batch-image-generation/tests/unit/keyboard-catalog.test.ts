...
import { usAnsiCatalog as advancedEditorUsAnsiCatalog } from '../../src/imgly/config/advanced-editor/keyboard/catalogs/us-ansi';
import { usAnsiCatalog as designEditorUsAnsiCatalog } from '../../src/imgly/config/design-editor/keyboard/catalogs/us-ansi';

const catalogs = [
  ['advanced-editor us-ansi', advancedEditorUsAnsiCatalog],
