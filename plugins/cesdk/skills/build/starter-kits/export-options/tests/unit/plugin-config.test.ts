...
describe('EO-U6 DesignEditorConfig', () => {
  ...
  it('resets the editor and applies compatibility, features, UI, actions, shortcuts and settings', async () => {
...
describe('EO-U7 setupVideoTimeline', () => {
