...
For complete integration guides and API reference, visit the [Form-Based Template Adoption Documentation](https://img.ly/docs/cesdk/js/starterkits/form-based-template-adoption-fbtmp1/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.82.2-rc.0/starterkit-form-based-template-adoption/demo-assets.zip
