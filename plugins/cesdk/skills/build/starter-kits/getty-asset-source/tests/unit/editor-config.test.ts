...
describe('GET-U20 setupPanels and setupUI', () => {
...
describe('GET-U21 setupCanvas and setupInspectorBar', () => {
...
describe('GET-U22 setupNavigationBar and setupSettings', () => {
...
describe('GET-U23 the setups this kit leaves empty', () => {
  it.each([
...
describe('GET-U24 DesignEditorConfig', () => {
...
describe('GET-U25 the action handlers the kit registers', () => {
  function handlers() {
