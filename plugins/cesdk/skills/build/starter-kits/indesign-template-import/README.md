...
For complete integration guides and API reference, visit the [InDesign Template Import Documentation](https://img.ly/docs/cesdk/js/starterkits/indesign-template-import-idml01/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.81.0-rc.1/starterkit-indesign-template-import/demo-assets.zip
