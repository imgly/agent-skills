...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.82.2-rc.0/starterkit-multi-image-generation/demo-assets.zip
...
The default URL is the `DEMO_ASSETS_BASE_URL` constant in `src/app/restaurant-catalog.ts` if you
