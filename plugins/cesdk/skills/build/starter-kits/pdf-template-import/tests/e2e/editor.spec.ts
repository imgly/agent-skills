...
test.describe('Editor', () => {
  ...
  test('PDF-11 Edit opens the imported scene in the editor', async ({
    page
  }) => {
    const app = new KitApp(page);
  ...
  test('PDF-12 Close returns to the result screen', async ({ page }) => {
    const app = new KitApp(page);
  ...
  test('PDF-13 the editor exports the imported page as an image', async ({
    page
  }) => {
    const app = new KitApp(page);
  ...
  test('PDF-14 the editor exports the imported page as a PDF', async ({
    page
  }) => {
    const app = new KitApp(page);
