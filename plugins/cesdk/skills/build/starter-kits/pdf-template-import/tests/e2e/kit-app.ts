...
const DEMO_DIR = resolve(
  ...
  'starterkit-pdf-template-import/cases/pdf-template-import'
);

export const EXAMPLES = ['Postcard PDF', 'Poster PDF', 'Social Media PDF'];

/** The smallest of the three demo files, so the upload cases stay quick. */
export const SMALLEST_DEMO_FILE = 'socialmedia.pdf';
...
export class KitApp {
  ...
  get uploadInput(): Locator {
    return this.page.getByLabel('Upload PDF File');
  }
