...
const DEMO_FILE = fileURLToPath(
  new URL(
    '../../../../../packages/cesdk-web-examples-data/data/starterkit-pdf-template-import/cases/pdf-template-import/socialmedia.pdf',
    import.meta.url
  )
);
