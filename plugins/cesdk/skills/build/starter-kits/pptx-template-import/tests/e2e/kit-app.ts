...
const DEMO_DIR = resolve(
  ...
  'starterkit-pptx-template-import/cases/pptx-template-import'
);

export const EXAMPLES = [
  'Skin Care Presentation PowerPoint',
  'Bike Presentation PowerPoint',
  'Social Media Presentation PowerPoint'
];

/** The smallest of the three demo files, so the upload cases stay quick. */
export const SMALLEST_DEMO_FILE = 'example-2-bike.pptx';
...
export class KitApp {
  ...
  get uploadInput(): Locator {
    return this.page.getByLabel('Upload PowerPoint File');
  }
