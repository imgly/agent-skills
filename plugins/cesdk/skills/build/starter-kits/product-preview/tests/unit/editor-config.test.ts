...
describe('PP-U10 setupPanels and setupUI', () => {
...
describe('PP-U11 setupCanvas and setupInspectorBar', () => {
...
describe('PP-U12 setupNavigationBar and setupSettings', () => {
...
describe('PP-U13 the setups this kit leaves empty', () => {
  it.each([
...
describe('PP-U14 DesignEditorConfig', () => {
...
describe('PP-U15 the action handlers the kit registers', () => {
  function handlers() {
