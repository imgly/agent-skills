...
test.describe('Editor', () => {
  ...
  test('PSD-12 Edit opens the imported scene in the editor', async ({
    page
  }) => {
    const app = new KitApp(page);
  ...
  test('PSD-13 Close returns to the result screen', async ({ page }) => {
    const app = new KitApp(page);
  ...
  test('PSD-14 the editor exports the imported page as an image', async ({
    page
  }) => {
    const app = new KitApp(page);
  ...
  test('PSD-15 the editor exports the imported page as a PDF', async ({
    page
  }) => {
    const app = new KitApp(page);
