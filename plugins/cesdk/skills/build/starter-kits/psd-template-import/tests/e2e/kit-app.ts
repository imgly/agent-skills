...
const DEMO_DIR = resolve(
  ...
  'starterkit-psd-template-import/cases/psd-template-import'
);

export const EXAMPLES = [
  'Skin Care Template Photoshop',
  'Landscape Photo Template Photoshop',
  'Business Card Template Photoshop'
];

/** The smallest of the three demo files, so the upload cases stay quick. */
export const SMALLEST_DEMO_FILE = 'showcase-file-3.psd';
...
export class KitApp {
  ...
  get uploadInput(): Locator {
    return this.page.getByLabel('Upload Photoshop File');
  }
