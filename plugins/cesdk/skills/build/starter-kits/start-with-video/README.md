...
For complete integration guides and API reference, visit the [Video Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/start-with-video-swv001/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.82.2-rc.0/starterkit-start-with-video/demo-assets.zip
...
The default URL is the `DEMO_ASSETS_BASE_URL` constant in `src/app/video-catalog.ts` if you
