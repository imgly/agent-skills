...
describe('TSD-U14 setupInspectorBar', () => {
...
describe('TSD-U16 the setups this kit leaves empty', () => {
  it.each([
...
describe('TSD-U17 ProductEditorConfig', () => {
  ...
  it('resets the editor before it configures anything', async () => {
    ...
    await new ProductEditorConfig().initialize({
      cesdk: cesdk.api,
      engine: engine.api
...
describe('TSD-U18 the action handlers the kit registers', () => {
  function handlers() {
