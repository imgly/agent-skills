...
import { LOCALES } from '../../src/app/LocaleSwitcher';
...
describe('LOCALES', () => {
  it('TI-U1 offers English and German, in that order', () => {
...
describe('setupTranslations', () => {
  it('TI-U4 registers no translations of its own', () => {
...
describe('setupActions', () => {
  ...
  it('TI-U8 registers the five actions the kit ships', () => {
...
describe('setupFeatures', () => {
  ...
  it.each([
    ...
    'ly.img.library.panel',
    'ly.img.inspector.bar'
  ])('TI-U5 enables %s', (feature) => {
    expect(enabled).toContain(feature);
  });

  it('TI-U5 leaves the video features off, as this is a design kit', () => {
...
describe('setupDock', () => {
  ...
  it('TI-U6 lists the seven libraries with the separator after Templates', () => {
    expect(
  ...
  it('TI-U6 shows labels and large icons', () => {
    const settings = new Map(
      spy
...
describe('setupNavigationBar', () => {
  ...
  it('TI-U6 ends with an actions dropdown holding Export image and Export PDF', () => {
...
describe('setupCanvas', () => {
  ...
  it('TI-U6 puts the canvas bar at the bottom without a page-select entry', () => {
    const bar = spy
      .callsTo('ui.setComponentOrder')
      .find(
...
describe('setupPanels', () => {
  ...
  it('TI-U6 docks the inspector and the asset library on the left', () => {
