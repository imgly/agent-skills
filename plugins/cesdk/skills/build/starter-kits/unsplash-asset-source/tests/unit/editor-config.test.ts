...
describe('UNS-U20 setupPanels and setupUI', () => {
...
describe('UNS-U21 setupCanvas and setupInspectorBar', () => {
...
describe('UNS-U22 setupNavigationBar and setupSettings', () => {
...
describe('UNS-U23 the setups this kit leaves empty', () => {
  it.each([
...
describe('UNS-U24 DesignEditorConfig', () => {
...
describe('UNS-U25 the action handlers the kit registers', () => {
  function handlers() {
