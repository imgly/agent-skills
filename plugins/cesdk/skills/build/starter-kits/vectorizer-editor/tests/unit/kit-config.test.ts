...
describe('V-U4b setupNavigationBar and setupActions', () => {
...
describe('V-U5 setupFeatures and setupSettings', () => {
  ...
  it.each([
    ...
    'ly.img.delete',
    'ly.img.navigation.bar'
  ])('enables %s, which the vectorizer flow needs', (feature) => {
