...
For complete integration guides and API reference, visit the [Video Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/video-animations-vanim1/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.82.0-rc.2/starterkit-video-animations/demo-assets.zip
...
The default URL is the `DEMO_ASSETS_BASE_URL` constant in `src/imgly/index.ts` if you
