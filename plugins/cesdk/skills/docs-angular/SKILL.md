...
name: docs-angular
description: |
  Look up CE.SDK Angular reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Angular — configuration, UI customization,
  ...
  an existing Angular documentation page or guide.
  ...
  <example>
  Context: User wants template loading
  user: "How do I load a design template in Angular with CE.SDK?"
  assistant: "I'll use /cesdk:docs-angular to look that up."
  </example>
