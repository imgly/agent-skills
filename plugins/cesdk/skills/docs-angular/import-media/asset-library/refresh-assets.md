...
**Navigation:** [Guides](./guides.md) > [Import Media Assets](./import-media.md) > [Asset Library](./import-media/asset-library.md) > [Refresh Assets](./import-media/asset-library/refresh-assets.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.83.0-nightly.20260831/examples/guides-import-media-asset-library-refresh-assets-browser/index.html)
