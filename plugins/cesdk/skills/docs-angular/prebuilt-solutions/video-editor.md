...
CreativeEditor SDK provides a powerful Angular library designed for creating
and editing videos directly in the browser.
...
## Key Capabilities of the Angular Video Editor SDK
...
<CapabilityGrid
  ...
  },
  {
    ...
    description:
      'Programmatically edit videos within your Angular application.',
    imageId: 'headless',
  },
  {
    title: 'Extendible',
...
If you're ready to start integrating CE.SDK into your Angular application, check out our [Getting Started guide](./get-started/overview.md) or explore the [Essential Guides](./guides.md).
...
## Customizing the Angular Video Editor
