...
A 3D product configurator for your Angular app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Mockup Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-3d-product-preview-react-web.git
        cp -r starterkit-3d-product-preview-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-3d-product-preview-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-3d-product-preview-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      init3dProductPreviewEditor = init3dProductPreviewEditor;
    }
    ```
...
```typescript title="src/app/imgly/mockup.ts"
