...
AI-powered creative editing for your Angular app—generate images, videos, audio,
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the AI Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-ai-editor-react-web.git
        cp -r starterkit-ai-editor-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-ai-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-ai-editor-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design">
        ...
        export class DesignEditorComponent {
          init = (cesdk: any) => initAiDesignEditor(cesdk, providers);
        }
        ```
      </TabItem>
      ...
      <TabItem label="Photo">
        ...
        export class DesignEditorComponent {
          init = (cesdk: any) => initAiPhotoEditor(cesdk, providers);
        }
        ```
      </TabItem>
      ...
      <TabItem label="Video">
        ...
        export class DesignEditorComponent {
          init = (cesdk: any) => initAiVideoEditor(cesdk, providers);
        }
        ```
      </TabItem>
    </Tabs>
...
```typescript title="src/app/imgly/plugins/ai-app/ai-providers.ts"
...
```typescript title="src/app/imgly/config/index.ts"
...
```typescript title="src/app/imgly/config/design-editor/plugin.ts"
import {
  FiltersAssetSource,
  StickerAssetSource,
  TextAssetSource,
...
```typescript title="src/app/imgly/config/design-editor/actions.ts"
...
```typescript title="src/app/imgly/config/design-editor/settings.ts"
...
```typescript title="src/app/imgly/config/design-editor/i18n.ts"
...
```typescript title="src/app/imgly/config/design-editor/features.ts"
...
```typescript title="src/app/imgly/plugins/ai-app/ai-apps.ts"
...
```typescript title="src/app/imgly/plugins/background-removal.ts"
