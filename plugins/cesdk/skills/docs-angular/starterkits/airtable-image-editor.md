...
Airtable image integration for your Angular app—browse and search images from your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Airtable Image Editor integration.
    ...
    Create an Angular component using the CE.SDK imperative API (e.g., `airtable-image-editor.component.ts`):
    ...
    @Component({
      selector: 'app-airtable-image-editor',
      standalone: true,
      template: `<div #container style="width: 100vw; height: 100vh;"></div>`
    })
    export class AirtableImageEditorComponent implements OnInit, OnDestroy {
      ...
      async ngOnInit() {
        ...
        await initAirtableImageEditor(this.cesdk, { airtableApiKey: AIRTABLE_API_KEY });
      }
    ...
    import { AirtableImageEditorComponent } from './airtable-image-editor/airtable-image-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [AirtableImageEditorComponent],
      template: `<app-airtable-image-editor />`
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Airtable Image Editor into an existing Angular application. This adds the editor configuration to your current project structure.
