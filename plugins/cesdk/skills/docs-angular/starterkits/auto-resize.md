...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Resizing into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automated-resizing-react-web.git
        cp -r starterkit-automated-resizing-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-automated-resizing-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automated-resizing-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design Editor">
        ...
        export class DesignEditorComponent {
          initAutomatedResizingDesignEditor = initAutomatedResizingDesignEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Advanced Editor">
        ...
        export class DesignEditorComponent {
          initAutomatedResizingAdvancedEditor = initAutomatedResizingAdvancedEditor;
        }
        ```
      </TabItem>
    </Tabs>
...
```tsx title="src/app/imgly/index.ts"
...
```tsx title="src/app/imgly/constants.ts"
{
  id: 'ig-story',
...
```tsx title="src/app/imgly/resizing.ts"
...
```tsx title="src/app/imgly/config/settings.ts"
...
```tsx title="src/app/imgly/config/i18n.ts"
...
```tsx title="src/app/imgly/config/ui/navigationBar.ts"
...
```tsx title="src/app/imgly/config/features.ts"
