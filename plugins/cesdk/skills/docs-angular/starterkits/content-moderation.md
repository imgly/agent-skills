...
Content moderation for your Angular app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-content-moderation-react-web.git
        cp -r starterkit-content-moderation-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-content-moderation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-content-moderation-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initContentModerationEditor = initContentModerationEditor;
    }
    ```
...
```typescript title="src/app/imgly/utils.ts"
import type { CreativeEngine } from '@cesdk/cesdk-js';
