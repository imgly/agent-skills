...
Print-ready cutout line creation for your Angular app—create customizable cutout lines with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Cutout Lines Editor integration.
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">npm install @imgly/plugin-cutout-lines-web</TerminalTab>
      <TerminalTab label="pnpm">pnpm add @imgly/plugin-cutout-lines-web</TerminalTab>
      <TerminalTab label="yarn">yarn add @imgly/plugin-cutout-lines-web</TerminalTab>
    </TerminalTabs>
    ...
    ```bash
    ng generate component cutout-lines-editor
    ```

    Update `cutout-lines-editor.component.ts`:
    ...
    @Component({
      selector: 'app-cutout-lines-editor',
      standalone: true,
      template: '<div #container style="width: 100%; height: 100vh;"></div>',
    })
    export class CutoutLinesEditorComponent implements OnInit, OnDestroy {
      ...
      async ngOnInit() {
        ...
        await initCutoutLinesEditor(this.cesdk);
      }
    ...
    ```typescript
    import { CutoutLinesEditorComponent } from './cutout-lines-editor/cutout-lines-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [CutoutLinesEditorComponent],
      template: '<app-cutout-lines-editor></app-cutout-lines-editor>',
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Cutout Lines Editor into an existing Angular application.
