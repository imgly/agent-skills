...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Data Merge into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-batch-image-generation-react-web.git
        cp -r starterkit-batch-image-generation-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-batch-image-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-batch-image-generation-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Template Editor">
        ...
        export class DesignEditorComponent {
          initBatchImageGenerationTemplateEditor = initBatchImageGenerationTemplateEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Instance Editor">
        ...
        export class DesignEditorComponent {
          initBatchImageGenerationInstanceEditor = initBatchImageGenerationInstanceEditor;
        }
        ```
      </TabItem>
    </Tabs>
...
```typescript title="src/app/imgly/batch-renderer.ts"
