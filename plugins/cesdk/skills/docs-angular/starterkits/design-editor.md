...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-design-editor-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-design-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-design-editor-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initDesignEditor = initDesignEditor;
    }
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Editor into an existing Angular application. This adds the editor configuration to your current project structure.
