...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automatic Design Generation into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automatic-design-generation-react-web.git
        cp -r starterkit-automatic-design-generation-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-automatic-design-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automatic-design-generation-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design">
        ...
        export class DesignEditorComponent {
          initDesignGenerationDesignEditor = initDesignGenerationDesignEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Video">
        ...
        export class DesignEditorComponent {
          initDesignGenerationVideoEditor = initDesignGenerationVideoEditor;
        }
        ```
      </TabItem>
    </Tabs>
