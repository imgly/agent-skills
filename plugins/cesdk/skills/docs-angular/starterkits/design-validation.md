...
Design validation for your Angular app—ensure designs meet requirements before export. Detect elements outside page bounds, protruding elements, hidden text, and low-resolution images. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Validation Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-design-validation-react-web.git
        cp -r starterkit-design-validation-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-design-validation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-design-validation-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initDesignValidationEditor = initDesignValidationEditor;
    }
    ```
...
```typescript title="src/app/imgly/validation.ts"
...
```typescript title="src/app/imgly/types.ts"
