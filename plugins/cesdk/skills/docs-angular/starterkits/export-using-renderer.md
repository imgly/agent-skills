...
Server-side video export for your Angular app—export videos with GPU-accelerated rendering. Uses the CE.SDK Renderer API for server-side processing with progress tracking.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Export Using Renderer integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-export-using-renderer-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-export-using-renderer-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-using-renderer-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initExportUsingRenderer = initExportUsingRenderer;
    }
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing Angular application. This adds the editor configuration to your current project structure.
