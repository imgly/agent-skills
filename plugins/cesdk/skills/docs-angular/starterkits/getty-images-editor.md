...
Getty Images premium stock photo integration for your Angular app—search and browse millions
of high-quality stock photos from Getty Images directly within your editor. Requires a proxy server for Getty Images API authentication.
