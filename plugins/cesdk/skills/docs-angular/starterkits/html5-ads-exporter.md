...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with HTML5 Ads Exporter integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-html5-ads-exporter-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-html5-ads-exporter-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-html5-ads-exporter-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initHtml5ExporterEditor = initHtml5ExporterEditor;
    }
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing Angular application. This adds the editor configuration to your current project structure.
