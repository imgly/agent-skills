...
Professional layout-based editing for your Angular app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Layouts Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-layouts-asset-source-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-layouts-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-layouts-asset-source-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class LayoutsEditorComponent {
      initLayoutsAssetSource = initLayoutsAssetSource;
    }
    ```
    ...
    ```typescript
    import { Component } from '@angular/core';
    import { LayoutsEditorComponent } from './design-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [LayoutsEditorComponent],
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Angular application. This adds the editor configuration to your current project structure.
...
The Layouts Editor includes a custom layouts plugin that allows users to choose from pre-designed layout templates and apply them to existing pages while preserving content. The plugin is implemented in `src/app/imgly/plugins/layouts/layout.ts`.
...
```typescript title="src/app/imgly/plugins/layouts/layout.ts"
