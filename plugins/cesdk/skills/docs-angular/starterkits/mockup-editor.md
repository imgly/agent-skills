...
Mockup rendering for your Angular app—render designs on product mockups in real-time. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Mockup Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-product-preview-react-web.git
        cp -r starterkit-product-preview-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-product-preview-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-product-preview-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design Editor">
        ...
        export class DesignEditorComponent {
          initProductPreviewDesignEditor = initProductPreviewDesignEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Mockup Scene Editor">
        ...
        export class DesignEditorComponent {
          initProductPreviewSceneEditor = initProductPreviewSceneEditor;
        }
        ```
      </TabItem>
    </Tabs>
