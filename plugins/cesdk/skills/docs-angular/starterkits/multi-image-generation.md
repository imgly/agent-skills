...
Generate multiple on-brand image variations from a single data source — and embed the entire workflow into your Angular application using CreativeEditor SDK (CE.SDK).
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Multi Image Generation into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-multi-image-generation-react-web.git
        cp -r starterkit-multi-image-generation-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-multi-image-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-multi-image-generation-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design Editor">
        ...
        export class DesignEditorComponent {
          initMultiImageGenerationDesignEditor = initMultiImageGenerationDesignEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Advanced Design Editor">
        ...
        export class DesignEditorComponent {
          initMultiImageGenerationAdvancedDesignEditor = initMultiImageGenerationAdvancedDesignEditor;
        }
        ```
      </TabItem>
    </Tabs>
