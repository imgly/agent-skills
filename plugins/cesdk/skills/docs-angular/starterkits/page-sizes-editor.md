...
Professional page size selection for your Angular app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Page Sizes Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-page-sizes-asset-source-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-page-sizes-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-page-sizes-asset-source-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class PageSizesEditorComponent {
      initPageSizesAssetSource = initPageSizesAssetSource;
    }
    ```
    ...
    ```typescript
    import { Component } from '@angular/core';
    import { PageSizesEditorComponent } from './design-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [PageSizesEditorComponent],
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Angular application. This adds the editor configuration to your current project structure.
