...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PDF Template Import into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-pdf-template-import-react-web.git
        cp -r starterkit-pdf-template-import-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-pdf-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-pdf-template-import-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initPdfTemplateImportEditor = initPdfTemplateImportEditor;
    }
    ```
