...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Perfectly Clear Editor integration.
    ...
    ```bash
    ng generate component perfectly-clear-editor
    ```

    Update `perfectly-clear-editor.component.ts`:
    ...
    @Component({
      selector: 'app-perfectly-clear-editor',
      standalone: true,
      template: '<div #container style="width: 100%; height: 100vh;"></div>',
    })
    export class PerfectlyClearEditorComponent implements OnInit, OnDestroy {
      ...
      async ngOnInit() {
        ...
        await initPerfectlyClearEditor(this.cesdk, { perfectlyClear: { apiKey: 'YOUR_PFC_API_KEY' } });
      }
    ...
    ```typescript
    import { PerfectlyClearEditorComponent } from './perfectly-clear-editor/perfectly-clear-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [PerfectlyClearEditorComponent],
      template: '<app-perfectly-clear-editor></app-perfectly-clear-editor>',
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Perfectly Clear Editor into an existing Angular application.
