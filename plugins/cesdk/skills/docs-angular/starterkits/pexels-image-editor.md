...
Pexels stock photo integration for your Angular app—search and browse millions of free stock photos from Pexels directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Pexels Image Editor integration.
    ...
    Create an Angular component using the CE.SDK imperative API (e.g., `pexels-image-editor.component.ts`):
    ...
    @Component({
      selector: 'app-pexels-image-editor',
      standalone: true,
      template: `<div #container style="width: 100vw; height: 100vh;"></div>`
    })
    export class PexelsImageEditorComponent implements OnInit, OnDestroy {
      ...
      async ngOnInit() {
        ...
        await initPexelsImageEditor(this.cesdk, { pexelsApiKey: PEXELS_API_KEY });
      }
    ...
    import { PexelsImageEditorComponent } from './pexels-image-editor/pexels-image-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [PexelsImageEditorComponent],
      template: `<app-pexels-image-editor />`
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    > **No Additional Dependencies:** The Pexels integration uses the built-in fetch API—no additional packages are needed beyond CE.SDK.
