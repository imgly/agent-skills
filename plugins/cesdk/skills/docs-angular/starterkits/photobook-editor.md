...
This guide assumes basic familiarity with Angular and TypeScript.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Photobook Editor project. This creates a complete, ready-to-run Angular application with a start screen, an editor, and an export pipeline.
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="pnpm">
        pnpm dlx @angular/cli@latest new your-project-name
        cd your-project-name
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn dlx @angular/cli@latest new your-project-name
        cd your-project-name
      </TerminalTab>
    </TerminalTabs>
    ...
    The component owns the container element, so there is no separate HTML step.Create the editor and hand it to `initPhotobookEditor` with the scene to open:

    ```typescript title="src/app/photobook-editor.component.ts"
    ...
    @Component({
      selector: 'app-photobook-editor',
      standalone: true,
      template: '<div #container style="width: 100vw; height: 100vh"></div>'
    })
    export class PhotobookEditorComponent implements OnInit, OnDestroy {
    ...
    import { PhotobookEditorComponent } from './photobook-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [PhotobookEditorComponent],
      template: '<app-photobook-editor />'
    })
