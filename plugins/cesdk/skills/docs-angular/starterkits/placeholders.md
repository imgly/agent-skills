...
Create reusable design templates with placeholder zones — right inside your Angular app. The Design Placeholders Editor is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline template-based design creation at scale.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Placeholders Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-placeholders-react-web.git
        cp -r starterkit-placeholders-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-placeholders-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-placeholders-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Creator">
        ...
        export class DesignEditorComponent {
          initPlaceholdersCreatorEditor = initPlaceholdersCreatorEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Adopter">
        ...
        export class DesignEditorComponent {
          initPlaceholdersAdopterEditor = initPlaceholdersAdopterEditor;
        }
        ```
      </TabItem>
    </Tabs>
