...
Import and edit PowerPoint files in your Angular app. Convert PPTX presentations to editable designs with full slide preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PowerPoint Template Import into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-pptx-template-import-react-web.git
        cp -r starterkit-pptx-template-import-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-pptx-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-pptx-template-import-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initPptxTemplateImportEditor = initPptxTemplateImportEditor;
    }
    ```
