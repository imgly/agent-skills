...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.82.0-nightly.20260826/examples/starterkit-print-ready-pdf-editor/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Angular application with Design Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-print-ready-pdf-editor-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-print-ready-pdf-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-print-ready-pdf-editor-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initPrintReadyPdfEditor = initPrintReadyPdfEditor;
    }
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Print-Ready PDF Editor into an existing Angular application. This adds the editor configuration to your current project structure.
...
To include bleed, the starter kit sets the page margin properties (`page/margin/top`, `page/margin/bottom`, `page/margin/left`, `page/margin/right` and `page/marginEnabled`) on each page before exporting — see `src/app/imgly/plugins/export-print-ready-pdf.ts` for the full implementation.
