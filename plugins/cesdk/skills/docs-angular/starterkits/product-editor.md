...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Product Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-product-editor-react-web.git
        cp -r starterkit-product-editor-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-product-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-product-editor-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initProductEditor = initProductEditor;
    }
    ```
