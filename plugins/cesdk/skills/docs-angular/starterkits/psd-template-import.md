...
Import and edit Adobe Photoshop files in your Angular app. Convert PSD templates to editable designs with full layer preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Photoshop Template Import into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-psd-template-import-react-web.git
        cp -r starterkit-psd-template-import-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-psd-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-psd-template-import-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initPsdTemplateImportEditor = initPsdTemplateImportEditor;
    }
    ```
