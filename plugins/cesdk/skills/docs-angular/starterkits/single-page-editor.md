...
Single-page design editing for your Angular app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Single Page Editor into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-single-page-editor-ts-web.git
        cp -r starterkit-single-page-editor-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-single-page-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-single-page-editor-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initSinglePageEditor = initSinglePageEditor;
    }
    ```
