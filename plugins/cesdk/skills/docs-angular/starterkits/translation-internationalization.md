...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Translation the Design Editor Internationalization into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-translation-internationalization-react-web.git
        cp -r starterkit-translation-internationalization-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-translation-internationalization-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-translation-internationalization-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initTranslationInternationalizationEditor = initTranslationInternationalizationEditor;
    }
    ```
