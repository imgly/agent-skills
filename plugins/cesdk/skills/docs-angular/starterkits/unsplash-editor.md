...
Design editor with integrated Unsplash image library for your Angular app. Search and use millions of free high-quality photos with automatic photographer attribution.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-unsplash-asset-source-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class UnsplashEditorComponent {
      initUnsplashEditor = initUnsplashEditor;
    }
    ```
    ...
    ```typescript
    import { Component } from '@angular/core';
    import { UnsplashEditorComponent } from './unsplash-editor.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [UnsplashEditorComponent],
      template: '<app-unsplash-editor />'
    })
