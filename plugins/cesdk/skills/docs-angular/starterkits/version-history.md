...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Version History into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-version-history-react-web.git
        cp -r starterkit-version-history-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-version-history-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-version-history-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export class DesignEditorComponent {
      initVersionHistoryEditor = initVersionHistoryEditor;
    }
    ```
...
```typescript title="src/app/imgly/history.ts"
