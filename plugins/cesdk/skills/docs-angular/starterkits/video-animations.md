...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-animations-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-video-animations-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-animations-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create an Angular component using the official CE.SDK Angular wrapper (e.g., `video-animations.component.ts`):
    ...
    export class VideoAnimationsEditorComponent {
      initVideoAnimationsEditor = initVideoAnimationsEditor;
    }
    ```
    ...
    ```typescript
    import { Component } from '@angular/core';
    import { VideoAnimationsEditorComponent } from './video-animations.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [VideoAnimationsEditorComponent],
      template: '<app-video-animations />'
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Animations into an existing Angular application. This adds the editor configuration to your current project structure.
