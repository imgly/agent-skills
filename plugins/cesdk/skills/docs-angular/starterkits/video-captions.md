...
AI-powered video captioning for your Angular app—auto-generate captions with ElevenLabs Scribe V2, import SRT files, or edit existing captions with professional styling controls. Runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Captions into an existing Angular application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-video-captions-react-web.git
        cp -r starterkit-video-captions-react-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-video-captions-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-captions-react-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Autocaption">
        ...
        export class DesignEditorComponent {
          initVideoCaptionsAutocaptionEditor = initVideoCaptionsAutocaptionEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Blank">
        ...
        export class DesignEditorComponent {
          initVideoCaptionsBlankEditor = initVideoCaptionsBlankEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Import">
        ...
        export class DesignEditorComponent {
          initVideoCaptionsImportEditor = initVideoCaptionsImportEditor;
        }
        ```
      </TabItem>
      ...
      <TabItem label="Pre-captioned">
        ...
        export class DesignEditorComponent {
          initVideoCaptionsPreCaptionedEditor = initVideoCaptionsPreCaptionedEditor;
        }
        ```
      </TabItem>
    </Tabs>
