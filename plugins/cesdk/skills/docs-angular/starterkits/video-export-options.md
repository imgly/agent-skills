...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-export-options-ts-web/src/app/imgly ./src/app/imgly
        rm -rf starterkit-video-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-export-options-ts-web/src/app/imgly ./src/app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create an Angular component using the official CE.SDK Angular wrapper (e.g., `video-export-options.component.ts`):
    ...
    @Component({
      selector: 'app-video-export-options',
      standalone: true,
    ...
    export class VideoExportOptionsEditorComponent {
      initVideoExportOptionsEditor = initVideoExportOptionsEditor;
    }
    ```
    ...
    ```typescript
    import { Component } from '@angular/core';
    import { VideoExportOptionsEditorComponent } from './video-export-options.component';

    @Component({
      selector: 'app-root',
      standalone: true,
      imports: [VideoExportOptionsEditorComponent],
      template: '<app-video-export-options />'
    })
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Export Options into an existing Angular application. This adds the editor configuration to your current project structure.
