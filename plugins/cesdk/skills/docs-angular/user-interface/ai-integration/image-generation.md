...
**Navigation:** [Guides](./guides.md) > [AI Features](./user-interface/ai-integration.md) > [Image Generation](./user-interface/ai-integration/image-generation.md) > [Plugins](./plugins.md) > [AI Image Generation](./user-interface/ai-integration/image-generation.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.84.0-nightly.20260922/examples/guides-user-interface-ai-integration-image-generation-browser/index.html)
