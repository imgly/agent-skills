...
The following sections provide an overview of the key components of the CE.SDK design editor UI and its API structure. If you're ready to begin integrating CE.SDK into your Angular application, refer to our [Getting Started guide](./get-started/overview.md) or delve into the Essential Guides.
...
[Asset API:](./import-media/concepts.md):
...
Explore more ways to extend editor functionality and customize its UI to your specific needs by consulting our detailed [customization guide](./user-interface.md).
...
Follow our [guide on building your own plugins](./user-interface.md) to learn more or explore some of the plugins we've created using this API:
