...
name: docs-electron
description: |
  Look up CE.SDK Electron reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Electron — configuration, UI customization,
  ...
  an existing Electron documentation page or guide.
  ...
  user: "Can CE.SDK work offline in an Electron desktop app?"
  assistant: "I'll use /cesdk:docs-electron to look that up."
  </example>
