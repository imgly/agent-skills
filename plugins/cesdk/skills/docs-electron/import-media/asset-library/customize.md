...
**Navigation:** [Guides](./guides.md) > [Import Media Assets](./import-media.md) > [Asset Library](./import-media/asset-library.md) > [Customize](./import-media/asset-library/customize.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.81.0-nightly.20260807/examples/guides-import-media-asset-library-customize-browser/index.html)
...
- [Asset Library Basics](./import-media/asset-library/basics.md) — Full reference for entry properties
- [Thumbnails](./import-media/asset-library/thumbnails.md) — Configure thumbnail display and grid layout
- [Refresh Assets](./import-media/asset-library/refresh-assets.md) — Update the library when external changes occur
