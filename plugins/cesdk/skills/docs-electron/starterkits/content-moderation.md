...
Content moderation for your Electron app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.
