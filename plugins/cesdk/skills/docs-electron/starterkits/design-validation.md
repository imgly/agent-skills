...
Design validation for your Electron app—ensure designs meet requirements before export. Detect elements outside page bounds, protruding elements, hidden text, and low-resolution images. Runs entirely in the browser with no server dependencies.
