...
Getty Images stock photo integration for your Electron app—search and browse
millions of premium stock photos from Getty Images directly within your
editor. Uses a server-side proxy for secure authentication.
