...
This guide assumes basic familiarity with Electron and TypeScript.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Photobook Editor project. This creates a complete, ready-to-run Electron application with a start screen, an editor, and an export pipeline.

    ## Step 1: Create a New Project

    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        npx create-electron-app@latest your-project-name --template=vite-typescript
        cd your-project-name
      </TerminalTab>

      <TerminalTab label="pnpm">
        pnpm dlx create-electron-app@latest your-project-name --template=vite-typescript
        cd your-project-name
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn dlx create-electron-app@latest your-project-name --template=vite-typescript
        cd your-project-name
      </TerminalTab>
    </TerminalTabs>
    ...
    > the `baseURL` in Step 5: Initialize the Editor.

    ## Step 5: Initialize the Editor

    Add the container to `index.html` at the project root, which the Forge template ships without a mount point:
    ...
    ```typescript title="src/renderer.ts"
  ...
  <TabItem label="Existing Project">
    ...
    > **Asset Configuration:** Set `baseURL` to where you serve these files in Step 4: Initialize the Editor.
