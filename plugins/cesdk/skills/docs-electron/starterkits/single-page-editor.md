...
Single-page design editing for your Electron app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.
