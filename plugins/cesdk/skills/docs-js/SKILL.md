...
name: docs-js
description: |
  Look up CE.SDK Vanilla JavaScript reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Vanilla JavaScript — configuration, UI customization,
  ...
  an existing Vanilla JavaScript documentation page or guide.
  ...
  <example>
  Context: User wants to manipulate blocks
  user: "How do I create and position image blocks with the CE.SDK API?"
  assistant: "I'll use /cesdk:docs-js to look that up."
  </example>
