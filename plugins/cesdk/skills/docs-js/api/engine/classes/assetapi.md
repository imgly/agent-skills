...
<details>
  ...
  Returns the value the source passed to [addSource](./api/engine/classes/assetapi.md), which the asset
  ...
  is asked about: a source registered through [addLocalSource](./api/engine/classes/assetapi.md) carries
...
<details>
  ...
  | ------ | ------ | ------ |
  | `assetResult` | [`AssetResult`](./api/engine/interfaces/assetresult.md) | A single asset result from a `findAssets` query. |
  | `options?` | [`DefaultApplyAssetOptions`](./api/engine/interfaces/defaultapplyassetoptions.md) | Optional configuration for asset application. |
