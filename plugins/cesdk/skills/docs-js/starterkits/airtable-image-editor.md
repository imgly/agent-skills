...
A design editor with Airtable integrated as a custom image source—browse and search images stored in your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.

![Airtable Image Editor starter kit showing custom Airtable image integration](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-airtable-asset-source-react-web my-project
        cd my-project
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs>
      <TerminalTab label="bash">
        ...
        # Edit .env and add your VITE\_AIRTABLE\_API\_KEY
      </TerminalTab>
    </TerminalTabs>

    Get your API key from your [Airtable account settings](https://support.airtable.com/docs/creating-and-using-api-keys-and-access-tokens).
  ...
  <TabItem label="Existing Project">
    ...
    ## Step 3: Configure Airtable API Key
...
> **Airtable Setup:** The starter kit uses a demo Airtable database. To use your own database, update the `databaseId` in the plugin options. Your database should have an "Asset sources" table with Name and Image fields.
...
```typescript title="src/imgly/plugins/airtable.ts"
...
- **Get your key**: Get your API key from your [Airtable account settings](https://support.airtable.com/docs/creating-and-using-api-keys-and-access-tokens)
