...
![Automated Video Generation starter kit showing video template editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-video-placeholders-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-video-placeholders-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Video Generation editor into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        npm install @cesdk/cesdk-js@$UBQ\_VERSION$ react react-dom
      </TerminalTab>

      <TerminalTab label="pnpm">
        pnpm add @cesdk/cesdk-js@$UBQ\_VERSION$ react react-dom
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn add @cesdk/cesdk-js@$UBQ\_VERSION$ react react-dom
      </TerminalTab>
    </TerminalTabs>
