...
AI-powered background removal for your web app—remove backgrounds from images with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Run the Background Removal Editor starter kit directly with Vite.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-background-removal-editor-ts-web my-project
        cd my-project
      </TerminalTab>
    </TerminalTabs>
    ...
    Open `http://localhost:5173` in your browser. Select an image and click "BG Removal" in the canvas menu to remove its background.
  </TabItem>

  <TabItem label="Existing Project">
    ## Get Started

    Integrate the Background Removal Editor into an existing vanilla JavaScript/TypeScript project. This adds the editor configuration to your current project structure.
    ...
    > **Asset Configuration:** The starter kit is pre-configured to load assets from `/assets`. If you place assets in a different location, update the `baseURL` in Step 4: Add a Container Element.
