...
Content moderation for your web app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.

![Content Moderation Editor starter kit showing content validation interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-content-moderation-react-web/tree/release-$UBQ_VERSION$)
>
