...
Print-ready cutout line creation for your web app—create die-cut lines from shapes with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Run the Cutout Lines Editor starter kit directly with Vite.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-cutout-lines-editor-ts-web my-project
        cd my-project
      </TerminalTab>
    </TerminalTabs>
    ...
    Open `http://localhost:5173` in your browser. Select a shape and right-click to create cutout lines.
  </TabItem>

  <TabItem label="Existing Project">
    ## Get Started

    Integrate the Cutout Lines Editor into an existing vanilla JavaScript/TypeScript project. This adds the editor configuration to your current project structure.
...
await cesdk.actions.run('exportDesign', { mimeType: 'application/pdf' });
```
...
The Cutout Lines Editor includes cutout line creation plus full design editing capabilities.
...
<CapabilityGrid
  ...
  },
  {
    title: 'PDF Export',
    description:
      'Export to print-ready PDF with spot colors for professional die-cutting and packaging.',
    imageId: 'transform',
  },
]}
/>
