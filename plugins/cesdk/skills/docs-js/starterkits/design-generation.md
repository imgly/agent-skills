...
![Automatic Design Generation starter kit showing a design generation interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate Automatic Design Generation into an existing React application. This adds the editor configuration to your current project structure.
    ...
    Install the Creative Editor SDK and headless engine:
