...
Design validation for your web app—ensure designs meet requirements before export. Detect elements outside page bounds, protruding elements, hidden text, and low-resolution images. Runs entirely in the browser with no server dependencies.

![Design Validation Editor starter kit showing design validation interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-design-validation-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-design-validation-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    The `imgly/` folder contains the editor configuration and validation logic:
