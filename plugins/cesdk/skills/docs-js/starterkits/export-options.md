...
![Export Options Editor starter kit showing an export panel with format, quality, and resolution settings](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-export-options-ts-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Options Editor into an existing web application. This adds the editor configuration to your current project structure.
