...
A design editor with Getty Images premium stock photos integrated as the primary image source—search and browse millions of high-quality images directly within your editor. Runs in the browser but requires a proxy server for Getty Images API authentication.
