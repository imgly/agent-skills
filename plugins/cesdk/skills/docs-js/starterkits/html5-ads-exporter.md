...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone HTML5 Ads Exporter project. This creates a complete, ready-to-run application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-html5-ads-exporter-ts-web starterkit-html5-ads-exporter-ts-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing web application. This adds the editor configuration to your current project structure.
