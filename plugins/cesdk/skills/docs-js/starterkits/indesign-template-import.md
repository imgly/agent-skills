...
Import and edit Adobe InDesign files in your web app. Convert IDML templates to editable designs with full layout preservation. Runs entirely in the browser with no server dependencies.

![InDesign Template Import starter kit showing IDML file import and editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-indesign-template-import-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-indesign-template-import-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate InDesign Template Import into an existing web application. This adds the editor configuration and IDML import functionality to your current project structure.
    ...
    The `imgly/` folder contains the editor configuration and IDML importer:
    ...
    Install the required packages for the editor and IDML import:
    ...
    Add InDesign file import support:
