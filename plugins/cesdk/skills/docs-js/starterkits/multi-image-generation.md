...
![Multi Image Generation starter kit showing batch image generation interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-multi-image-generation-react-web/tree/release-$UBQ_VERSION$)
>
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.83.0-nightly.20260829/examples/starterkit-multi-image-generation/index.html)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Multi Image Generation workflow into an existing web application. This adds the generation and editor configuration to your current project structure.
    ...
    The `imgly/` folder contains the SDK integration:
    ...
    Install the required packages for the editor and generation:
    ...
    ### Headless Engine (for Batch Generation)

    Install the headless engine for batch image generation:
