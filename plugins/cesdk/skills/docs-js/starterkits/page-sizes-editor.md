...
A design editor with a custom Page Sizes dock button that opens the built-in page resize panel. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Page Sizes Editor project. This creates a complete, ready-to-run application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-page-sizes-asset-source-ts-web starterkit-page-sizes-asset-source-ts-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing web application. This adds the editor configuration to your current project structure.
