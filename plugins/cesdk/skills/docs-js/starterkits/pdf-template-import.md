...
![PDF Template Import starter kit showing PDF file import and editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-pdf-template-import-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-pdf-template-import-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate PDF Template Import into an existing web application. This adds the editor configuration and PDF import functionality to your current project structure.
    ...
    The `imgly/` folder contains the editor configuration and PDF importer:
    ...
    Install the required packages for the editor and PDF import:
