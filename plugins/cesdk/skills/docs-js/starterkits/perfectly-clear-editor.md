...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Run the Perfectly Clear Editor starter kit directly with Vite.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-perfectlyclear-editor-ts-web my-project
        cd my-project
      </TerminalTab>
    </TerminalTabs>
    ...
    Open `http://localhost:5173` in your browser. Select an image and click "Enhance" in the canvas menu to apply scene-aware correction.
  </TabItem>

  <TabItem label="Existing Project">
    ## Get Started

    Integrate the Perfectly Clear Editor into an existing vanilla JavaScript/TypeScript project. This adds the editor configuration to your current project structure.
...
The editor provides one-click enhancement via the canvas menu:
...
The Perfectly Clear runtime analyzes the image and applies scene-aware correction — skin-tone, AI color, dynamic range, noise reduction — entirely in the browser.
...
The Perfectly Clear Editor includes image enhancement plus full design editing capabilities.
...
<CapabilityGrid
  features={[
  {
    ...
    description:
      'One-click enhancement using Perfectly Clear (eyeQ). Scene-aware correction — skin-tone, AI color, dynamic range, noise reduction — runs entirely in the browser via WebAssembly.',
    imageId: 'transform',
  },
  {
...
- **Select an image**: The Enhance option only appears when an image block is selected
- **Check the API key is authorized**: Perfectly Clear validates the page hostname against its certificate endpoint. Bind your key to every origin you ship from in the Perfectly Clear dashboard
