...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-photobook-editor-react-web starterkit-photobook-editor-react-web
        cd starterkit-photobook-editor-react-web
      </TerminalTab>
    </TerminalTabs>
    ...
    > **Asset Configuration:** The starter kit is pre-configured to load assets from `/assets`. If you place assets in a different location, update the `baseURL` in `src/client/src/index.tsx`. Browser-side export reads the same value.

    ```typescript title="src/client/src/index.tsx"
  ...
  <TabItem label="Existing Project">
    ...
    > **Asset Configuration:** Set `baseURL` to where you serve these files in Step 5: Create the Editor Component.
