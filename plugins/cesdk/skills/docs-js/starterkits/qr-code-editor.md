...
QR code generation for your web app—create customizable QR codes with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Run the QR Code Editor starter kit directly with Vite.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-qr-code-editor-ts-web my-project
        cd my-project
      </TerminalTab>
    </TerminalTabs>
    ...
    Open `http://localhost:5173` in your browser. Click the "QR Code" button in the dock to generate QR codes.
  </TabItem>

  <TabItem label="Existing Project">
    ## Get Started

    Integrate the QR Code Editor into an existing vanilla JavaScript/TypeScript project. This adds the editor configuration to your current project structure.
...
The QR Code Editor includes QR code generation plus full design editing capabilities.
