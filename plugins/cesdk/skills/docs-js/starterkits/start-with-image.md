...
![Start With Image Editor starter kit showing a design editor with an image loaded](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-start-with-image-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start With Image Editor into an existing web application. This adds the editor configuration to your current project structure.
