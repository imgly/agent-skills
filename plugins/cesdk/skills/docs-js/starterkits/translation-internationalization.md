...
Dynamic locale switching for your web editor—switch between English and German to see the entire UI update in real-time. Runs entirely in the browser with no server dependencies.

![Translation & Internationalization starter kit showing locale switching interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-translation-internationalization-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Translation & Internationalization editor into an existing web application. This adds the editor configuration with locale switching to your current project structure.
