...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Video Export Options project. This creates a complete, ready-to-run application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-export-options-ts-web starterkit-video-export-options-ts-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Export Options into an existing web application. This adds the editor configuration to your current project structure.
