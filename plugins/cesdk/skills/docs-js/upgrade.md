...
- [To v1.82](./to-v1-82.md) - Learn what changed in v1.82 for web — the video timeline controls bar is now driven by the Component Order API and ships without a built-in order, the clip ellipsis button gained its own feature flag, and the bundled typefaces now ship as WOFF2.
