...
name: docs-nextjs
description: |
  Look up CE.SDK Next.js reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Next.js — configuration, UI customization,
  ...
  an existing Next.js documentation page or guide.
  ...
  <example>
  Context: User wants dynamic import
  user: "How do I dynamically import CE.SDK in a Next.js page?"
  assistant: "I'll use /cesdk:docs-nextjs to look that up."
  </example>
