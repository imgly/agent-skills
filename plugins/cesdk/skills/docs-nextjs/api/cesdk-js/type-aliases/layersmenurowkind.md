...
```ts
type LayersMenuRowKind = "page" | "layer";
```

Which kind of row a layer list menu was opened from.

- `'page'` — a page row, which answers to the page commands
- `'layer'` — any other row, which answers to the arrange and group commands
