...
<details>
  ...
  conversion made right after the engine starts fails. Await this once and every later [convertColorToColorSpace](./api/engine/classes/editorapi.md) answers without handling `COLOR.PROFILE_NOT_LOADED`.
