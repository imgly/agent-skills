...
- Framework-specific headless quick starts for [React](#broken-link-h1f42n), [Next.js](./get-started/new-project-without-ui.md), [Vue](#broken-link-n7f18t), and [Angular](#broken-link-c1234j).
