...
**Navigation:** [Guides](./guides.md) > [Create and Use Templates](./create-templates.md) > [Insert Dynamic Content](./create-templates/add-dynamic-content.md) > [Form-Based Editing](./create-templates/add-dynamic-content/form-based-editing.md)
...
>
> - [Live demo](https://img.ly/docs/cesdk/examples/guides-create-templates-dynamic-content-form-based-editing-browser/)
