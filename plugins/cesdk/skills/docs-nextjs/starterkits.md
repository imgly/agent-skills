...
- [AI Editor for Next.js](./starterkits/ai-editor.md) - Quickly add AI-powered visual editing and media generation to your web app — seamlessly connect any AI model.
- [T-Shirt Designer for Next.js](./starterkits/t-shirt-designer.md) - Apparel Editor for creating print-ready design.
- [Product Editor for Next.js](./starterkits/product-editor.md) - Product Editor for customizing any product with print-ready designs.
- [Photobook Editor for Next.js](./starterkits/photobook-editor.md) - A complete photobook editor with a layouts library, photo auto-fill, live design validation, and export to print-ready PDF/X-4.
