...
A 3D product configurator for your Next.js app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Mockup Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
