...
Comprehensive video editing for your Next.js app—professional tools for timeline editing, visual effects, and MP4 export. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Integrate Video Editor (Advanced) into your Next.js application using the official React wrapper.
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="pnpm">
        pnpm create next-app@latest your-project-name
        cd your-project-name
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn create next-app@latest your-project-name
        cd your-project-name
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a client-side React component using the official CE.SDK React wrapper (e.g., `components/AdvancedVideoEditor.tsx`):
    ...
    const AdvancedVideoEditor = dynamic(
      () => import('./components/AdvancedVideoEditor'),
      { ssr: false }
    );

    export default function AdvancedVideoEditorComponent() {
      return <AdvancedVideoEditor />;
    }
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate Video Editor (Advanced) into an existing Next.js application. This adds the editor configuration to your current project structure.
