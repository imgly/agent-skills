...
Server-side video export for your Next.js app—export videos with GPU-accelerated rendering. Uses the CE.SDK Renderer API for server-side processing with progress tracking.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Export Using Renderer integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-export-using-renderer-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-export-using-renderer-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-using-renderer-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Export Using Renderer component in your page:
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing Next.js application. This adds the editor configuration to your current project structure.
