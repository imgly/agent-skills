...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Form-Based Template Adoption into an existing Next.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-form-based-template-adoption-ts-web.git
        cp -r starterkit-form-based-template-adoption-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-form-based-template-adoption-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-form-based-template-adoption-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Form-Based Template Adoption component in your page:
