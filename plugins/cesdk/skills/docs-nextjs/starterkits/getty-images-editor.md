...
Getty Images stock photo integration for your Next.js app—search and browse millions of premium stock photos from Getty Images directly within your editor. Requires a proxy server for Getty Images API authentication.
...
- **Getty Images Proxy Server** – Set up a proxy server to authenticate requests to Getty Images API
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Getty Images Editor integration.
    ...
    Create a client component using the official CE.SDK React wrapper (e.g., `GettyImagesEditor.tsx`):
    ...
    Import and use the Getty Images Editor component in a page (e.g., `app/page.tsx`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Getty Images Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
...
> **Proxy Server Required:** To use Getty Images in production, you need a proxy server that authenticates requests to the Getty Images API.
> Set it via the `VITE_GETTY_IMAGES_PROXY_URL` environment variable or pass it to `initGettyImagesEditor()`.
...
<CapabilityGrid
  features={[
  {
    ...
    description:
      'Access millions of premium stock photos from Getty Images. Search and browse directly within the editor.',
  ...
  },
  {
    ...
    description:
      'Getty Images API authentication is handled server-side via a proxy server for secure credential management.',
    imageId: 'client-side',
  },
  {
...
- **Verify proxy configuration**: Test your proxy server is correctly configured to authenticate with Getty Images API
