...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with HTML5 Ads Exporter integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing Next.js application. This adds the editor configuration to your current project structure.
