...
Import and edit Adobe InDesign files in your Next.js app. Convert IDML templates to editable designs with full layout preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the InDesign Template Import into an existing Next.js application. This adds the editor configuration to your current project structure.
