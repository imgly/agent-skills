...
Professional layout-based editing for your Next.js app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Layouts Editor integration.
    ...
    Create a client-side React component using the official CE.SDK React wrapper (e.g., `LayoutsEditor.tsx`):
    ...
    const LayoutsEditor = dynamic(
      () => import('./components/LayoutsEditor'),
      { ssr: false }
    );
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
