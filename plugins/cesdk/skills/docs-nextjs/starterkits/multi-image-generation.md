...
Generate multiple on-brand image variations from a single data source — and embed the entire workflow into your Next.js application using CreativeEditor SDK (CE.SDK).
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Multi Image Generation into an existing Next.js application. This adds the editor configuration to your current project structure.
