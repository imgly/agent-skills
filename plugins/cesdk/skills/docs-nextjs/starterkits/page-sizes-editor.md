...
Professional page size selection for your Next.js app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Page Sizes Editor integration.
    ...
    Create a client-side React component using the official CE.SDK React wrapper (e.g., `PageSizesEditor.tsx`):
    ...
    const PageSizesEditor = dynamic(
      () => import('./components/PageSizesEditor'),
      { ssr: false }
    );
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
