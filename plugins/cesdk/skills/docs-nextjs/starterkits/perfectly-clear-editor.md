...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Perfectly Clear Editor integration.
    ...
    Create a client component using the official CE.SDK React wrapper (e.g., `PerfectlyClearEditor.tsx`):
    ...
    Import and use the Perfectly Clear Editor component in a page (e.g., `app/page.tsx`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Perfectly Clear Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
