...
Pexels stock photo integration for your Next.js app—search and browse millions of free stock photos from Pexels directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with Pexels Image Editor integration.
    ...
    Create a client component using the official CE.SDK React wrapper (e.g., `PexelsImageEditor.tsx`):
    ...
    Import and use the Pexels Image Editor component in a page (e.g., `app/page.tsx`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
