...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.84.0-nightly.20260922/examples/starterkit-photobook-editor/index.html)

***

## Pre-requisites

This guide assumes basic familiarity with Next.js and TypeScript.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Photobook Editor project. This creates a complete, ready-to-run Next.js application with a start screen, an editor, and an export pipeline.
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="pnpm">
        pnpm create next-app@latest your-project-name --typescript
        cd your-project-name
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn create next-app@latest your-project-name --typescript
        cd your-project-name
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs>
      <TerminalTab label="degit">
        npx degit imgly/starterkit-photobook-editor-react-web/src/client/src/imgly ./app/imgly
      </TerminalTab>

      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-photobook-editor-react-web.git
        cp -r starterkit-photobook-editor-react-web/src/client/src/imgly ./app/imgly
    ...
    ```tsx title="app/PhotobookEditor.tsx"
    'use client';
