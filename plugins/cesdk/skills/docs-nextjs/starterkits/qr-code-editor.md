...
QR code generation for your Next.js app—create customizable QR codes with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Next.js application with QR Code Editor integration.
    ...
    Create a client component using the official CE.SDK React wrapper (e.g., `QRCodeEditor.tsx`):
    ...
    Import and use the QR Code Editor component in a page (e.g., `app/page.tsx`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the QR Code Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
