...
Single-page design editing for your Next.js app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Single Page Editor into an existing Next.js application. This adds the editor configuration to your current project structure.
