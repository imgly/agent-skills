...
Customize t-shirts with front and back print areas in your Next.js app. Includes 10 color options, size selection, quantity controls, and e-commerce cart integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the T-Shirt Designer into an existing Next.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-t-shirt-designer-react-web.git
        cp -r starterkit-t-shirt-designer-react-web/app/imgly ./app/imgly
        rm -rf starterkit-t-shirt-designer-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-t-shirt-designer-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the T-Shirt Designer component in your page:
