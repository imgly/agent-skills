...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Version History into an existing Next.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-version-history-react-web.git
        cp -r starterkit-version-history-react-web/app/imgly ./app/imgly
        rm -rf starterkit-version-history-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-version-history-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Version History component in your page:
...
```typescript title="app/imgly/history.ts"
