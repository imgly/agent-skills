...
Integrate the Video Animations into your Next.js application using the official React wrapper.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-animations-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-video-animations-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-animations-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    const VideoAnimationsEditor = dynamic(
      () => import('./components/VideoAnimationsEditor'),
      { ssr: false }
    );

    export default function VideoAnimationsEditorComponent() {
      return <VideoAnimationsEditor />;
    }
    ```
  </TabItem>
