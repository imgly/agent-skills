...
AI-powered video captioning for your Next.js app—auto-generate captions with ElevenLabs Scribe V2, import SRT files, or edit existing captions with professional styling controls. Runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Captions into an existing Next.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-video-captions-react-web.git
        cp -r starterkit-video-captions-react-web/app/imgly ./app/imgly
        rm -rf starterkit-video-captions-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-captions-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
