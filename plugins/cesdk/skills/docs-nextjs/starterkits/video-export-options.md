...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.82.0-nightly.20260824/examples/starterkit-video-export-options/index.html)
...
Integrate the Video Export Options into your Next.js application using the official React wrapper.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-export-options-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-video-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-export-options-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    const VideoExportOptionsEditor = dynamic(
      () => import('./components/VideoExportOptionsEditor'),
      { ssr: false }
    );

    export default function VideoExportOptionsEditorComponent() {
      return <VideoExportOptionsEditor />;
    }
    ```
  </TabItem>
