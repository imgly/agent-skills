...
- [Supported Animation Types](./animation/types.md) - Apply different animation types to design blocks in CE.SDK and configure their properties in server-side applications.
