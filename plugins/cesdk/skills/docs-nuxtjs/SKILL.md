...
name: docs-nuxtjs
description: |
  Look up CE.SDK Nuxt.js reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Nuxt.js — configuration, UI customization,
  ...
  an existing Nuxt.js documentation page or guide.
  ...
  <example>
  Context: User wants to add text
  user: "How do I add and style text blocks in my Nuxt CE.SDK editor?"
  assistant: "I'll use /cesdk:docs-nuxtjs to look that up."
  </example>
