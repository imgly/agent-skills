...
```ts
type SelectionArrangeAction = () => void;
```

Action function for moving the selection one step through its parent's
stacking order, or all the way to either end of it.
