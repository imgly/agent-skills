...
|  `page/exclusionAreaFillColor` | [`Color`](./api/engine/type-aliases/color.md) | The color washed over an exclusion area. |
|  `page/exclusionAreaFrameColor` | [`Color`](./api/engine/type-aliases/color.md) | The color of the frame around an exclusion area. |
...
|  `page/safetyFillColor` | [`Color`](./api/engine/type-aliases/color.md) | The color filled into the safety inset band of pages. |
|  `page/safetyFrameColor` | [`Color`](./api/engine/type-aliases/color.md) | The color of the frame around the safety inset of the pages. |
