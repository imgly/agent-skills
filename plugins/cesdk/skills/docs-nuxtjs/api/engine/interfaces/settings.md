...
|  `page/forbiddenZoneFillColor` | [`Color`](./api/engine/type-aliases/color.md) | The color washed over a forbidden zone. |
|  `page/forbiddenZoneFrameColor` | [`Color`](./api/engine/type-aliases/color.md) | The color of the frame around a forbidden zone. |
...
|  `page/safetyFillColor` | [`Color`](./api/engine/type-aliases/color.md) | The color filled into the safety area band of pages. |
|  `page/safetyFrameColor` | [`Color`](./api/engine/type-aliases/color.md) | The color of the frame around the safety area of the pages. |
