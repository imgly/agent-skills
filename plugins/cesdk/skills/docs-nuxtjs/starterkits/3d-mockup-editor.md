...
A 3D product configurator for your Nuxt.js app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Mockup Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-3d-product-preview-react-web.git
        cp -r starterkit-3d-product-preview-react-web/app/imgly ./app/imgly
        rm -rf starterkit-3d-product-preview-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-3d-product-preview-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">npm install @cesdk/engine</TerminalTab>
      <TerminalTab label="pnpm">pnpm add @cesdk/engine</TerminalTab>
      <TerminalTab label="yarn">yarn add @cesdk/engine</TerminalTab>
    </TerminalTabs>
    ...
    Create a client-only Vue component using the `.client.vue` suffix (e.g., `DesignEditor.client.vue`):
    ...
    Save this file as `components/DesignEditor.client.vue` to ensure it only renders on the client.

    ## Step 5: Use the Component

    Import and use the 3D Mockup Editor component in your page:
    ...
    <script setup lang="ts">
    import DesignEditor from '~/components/DesignEditor.client.vue';
    </script>
    ```
...
```typescript title="app/imgly/mockup.ts"
