...
Airtable image integration for your Nuxt.js app—browse and search images from your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-airtable-asset-source-react-web/app/imgly ./app/imgly
