...
Transform a single design into multiple platform-optimized sizes using content-aware resizing. Generate Instagram, Facebook, X, LinkedIn, and YouTube variants—all in one click.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Resizing into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automated-resizing-react-web.git
        cp -r starterkit-automated-resizing-react-web/app/imgly ./app/imgly
        rm -rf starterkit-automated-resizing-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automated-resizing-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
...
```tsx title="app/imgly/constants.ts"
{
  id: 'ig-story',
...
```tsx title="app/imgly/resizing.ts"
...
```tsx title="app/imgly/config/settings.ts"
...
```tsx title="app/imgly/config/i18n.ts"
...
```tsx title="app/imgly/config/ui/navigationBar.ts"
...
```tsx title="app/imgly/config/features.ts"
