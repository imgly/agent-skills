...
Content moderation for your Nuxt.js app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-content-moderation-react-web.git
        cp -r starterkit-content-moderation-react-web/app/imgly ./app/imgly
        rm -rf starterkit-content-moderation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-content-moderation-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Content Moderation Editor component in your page:
...
```typescript title="app/imgly/utils.ts"
import type { CreativeEngine } from '@cesdk/cesdk-js';
