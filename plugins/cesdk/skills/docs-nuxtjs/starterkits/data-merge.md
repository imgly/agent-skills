...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Data Merge into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-batch-image-generation-react-web.git
        cp -r starterkit-batch-image-generation-react-web/app/imgly ./app/imgly
        rm -rf starterkit-batch-image-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-batch-image-generation-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
...
```typescript title="app/imgly/batch-renderer.ts"
