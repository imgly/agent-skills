...
Generate designs programmatically for different sizes and formats. Supports both image and video output with built-in editing previews. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automatic Design Generation into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automatic-design-generation-react-web.git
        cp -r starterkit-automatic-design-generation-react-web/app/imgly ./app/imgly
        rm -rf starterkit-automatic-design-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automatic-design-generation-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
