...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Options Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-export-options-ts-web.git
        cp -r starterkit-export-options-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-options-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Export Options Editor component in your page:
...
```typescript title="app/imgly/plugins/export-design-panel.ts"
