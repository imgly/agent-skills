...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Force Crop Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-force-crop-editor-react-web.git
        cp -r starterkit-force-crop-editor-react-web/app/imgly ./app/imgly
        rm -rf starterkit-force-crop-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-force-crop-editor-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Force Crop Editor component in your page:
