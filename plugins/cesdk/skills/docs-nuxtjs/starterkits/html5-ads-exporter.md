...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.80.0-nightly.20260727/examples/starterkit-html5-ads-exporter/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with HTML5 Ads Exporter integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-html5-ads-exporter-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-html5-ads-exporter-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-html5-ads-exporter-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
