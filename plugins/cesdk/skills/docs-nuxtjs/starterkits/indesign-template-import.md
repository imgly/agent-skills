...
Import and edit Adobe InDesign files in your Nuxt.js app. Convert IDML templates to editable designs with full layout preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the InDesign Template Import into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-indesign-template-import-react-web.git
        cp -r starterkit-indesign-template-import-react-web/app/imgly ./app/imgly
        rm -rf starterkit-indesign-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-indesign-template-import-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the InDesign Template Import component in your page:
