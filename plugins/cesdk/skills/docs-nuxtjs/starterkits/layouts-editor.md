...
Professional layout-based editing for your Nuxt.js app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with Layouts Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-layouts-asset-source-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-layouts-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-layouts-asset-source-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a client-only Vue component using the `.client.vue` suffix (e.g., `LayoutsEditor.client.vue`):
    ...
    Save this file as `components/LayoutsEditor.client.vue` to ensure it only renders on the client.

    ## Step 6: Use the Component

    Import and use the Layouts Editor component in your page:
    ...
    <script setup lang="ts">
    import LayoutsEditor from '~/components/LayoutsEditor.client.vue';
    </script>
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    CE.SDK requires engine assets (fonts, icons, UI elements) to function. For Nuxt.js projects, place these in your `public/` directory which is served automatically.
...
The Layouts Editor includes a custom layouts plugin that allows users to choose from pre-designed layout templates and apply them to existing pages while preserving content. The plugin is implemented in `app/imgly/plugins/layouts/layout.ts`.
...
```typescript title="app/imgly/plugins/layouts/layout.ts"
