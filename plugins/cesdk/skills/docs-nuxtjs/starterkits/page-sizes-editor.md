...
Professional page size selection for your Nuxt.js app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with Page Sizes Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-page-sizes-asset-source-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-page-sizes-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-page-sizes-asset-source-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a client-only Vue component using the `.client.vue` suffix (e.g., `PageSizesEditor.client.vue`):
    ...
    Save this file as `components/PageSizesEditor.client.vue` to ensure it only renders on the client.

    ## Step 6: Use the Component

    Import and use the Page Sizes Editor component in your page:
    ...
    <script setup lang="ts">
    import PageSizesEditor from '~/components/PageSizesEditor.client.vue';
    </script>
    ```
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
