...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with Perfectly Clear Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-perfectlyclear-editor-ts-web/src/imgly ./imgly
        rm -rf starterkit-perfectlyclear-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-perfectlyclear-editor-ts-web/src/imgly ./imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create `components/PerfectlyClearEditor.vue`:
    ...
    onMounted(async () => {
      if (import.meta.client && containerRef.value) {
        ...
        const { initPerfectlyClearEditor } = await import('../imgly');
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Perfectly Clear Editor into an existing Nuxt.js application.
