...
This guide assumes basic familiarity with Nuxt and TypeScript.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Photobook Editor project. This creates a complete, ready-to-run Nuxt application with a start screen, an editor, and an export pipeline.
    ...
    ```vue title="components/PhotobookEditor.client.vue"
