...
Create reusable design templates with placeholder zones — right inside your Nuxt.js app. The Design Placeholders Editor is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline template-based design creation at scale.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Placeholders Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
