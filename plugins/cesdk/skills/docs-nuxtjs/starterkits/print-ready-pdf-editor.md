...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-print-ready-pdf-editor-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-print-ready-pdf-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-print-ready-pdf-editor-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Print-Ready PDF Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
...
To include bleed, the starter kit sets the page margin properties (`page/margin/top`, `page/margin/bottom`, `page/margin/left`, `page/margin/right` and `page/marginEnabled`) on each page before exporting — see `app/imgly/plugins/export-print-ready-pdf.ts` for the full implementation.
