...
Design on multiple products including t-shirts, caps, mugs, phone cases, tote bags, and arrow signs. Includes 6 color options per product, size selection, quantity controls, and e-commerce cart integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Product Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-product-editor-react-web.git
        cp -r starterkit-product-editor-react-web/app/imgly ./app/imgly
        rm -rf starterkit-product-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-product-editor-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Product Editor component in your page:
