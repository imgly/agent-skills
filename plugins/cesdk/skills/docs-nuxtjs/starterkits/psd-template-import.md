...
Import and edit Adobe Photoshop files in your Nuxt.js app. Convert PSD templates to editable designs with full layer preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Photoshop Template Import into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-psd-template-import-react-web.git
        cp -r starterkit-psd-template-import-react-web/app/imgly ./app/imgly
        rm -rf starterkit-psd-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-psd-template-import-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Photoshop Template Import component in your page:
