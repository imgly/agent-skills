...
QR code generation for your Nuxt.js app—create customizable QR codes with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with QR Code Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-qr-code-editor-ts-web/src/imgly ./imgly
        rm -rf starterkit-qr-code-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-qr-code-editor-ts-web/src/imgly ./imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create `components/QRCodeEditor.vue`:
    ...
    onMounted(async () => {
      if (import.meta.client && containerRef.value) {
        ...
        const { initQRCodeEditor } = await import('../imgly');
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the QR Code Editor into an existing Nuxt.js application.
