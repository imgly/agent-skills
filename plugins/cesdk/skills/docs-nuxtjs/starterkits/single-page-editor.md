...
Single-page design editing for your Nuxt.js app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Single Page Editor into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-single-page-editor-ts-web.git
        cp -r starterkit-single-page-editor-ts-web/app/imgly ./app/imgly
        rm -rf starterkit-single-page-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-single-page-editor-ts-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Single Page Editor component in your page:
