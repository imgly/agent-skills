...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start With Image into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-image-react-web.git
        cp -r starterkit-start-with-image-react-web/app/imgly ./app/imgly
        rm -rf starterkit-start-with-image-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-image-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Start With Image component in your page:
