...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start with Video into an existing Nuxt.js application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-video-react-web.git
        cp -r starterkit-start-with-video-react-web/app/imgly ./app/imgly
        rm -rf starterkit-start-with-video-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-video-react-web/app/imgly ./app/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Start with Video component in your page:
