...
Image vectorization for your Nuxt.js app—create customizable Image vectorizations with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Nuxt.js application with Vectorizer Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-vectorizer-editor-ts-web/src/imgly ./imgly
        rm -rf starterkit-vectorizer-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-vectorizer-editor-ts-web/src/imgly ./imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create `components/VectorizerEditor.vue`:
    ...
    onMounted(async () => {
      if (import.meta.client && containerRef.value) {
        ...
        const { initVectorizerEditor } = await import('../imgly');
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Vectorizer Editor into an existing Nuxt.js application.
