...
Integrate the Video Animations into your Nuxt.js application using the official Vue wrapper.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Save this file as `components/VideoAnimationsEditor.client.vue` to ensure it only renders on the client.
    ...
    <script setup lang="ts">
    import VideoAnimationsEditor from './components/VideoAnimationsEditor.client.vue';
    </script>
    ```
