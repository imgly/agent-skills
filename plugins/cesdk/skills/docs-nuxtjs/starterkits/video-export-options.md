...
Integrate the Video Export Options into your Nuxt.js application using the official Vue wrapper.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Save this file as `components/VideoExportOptionsEditor.client.vue` to ensure it only renders on the client.
    ...
    <script setup lang="ts">
    import VideoExportOptionsEditor from './components/VideoExportOptionsEditor.client.vue';
    </script>
    ```
