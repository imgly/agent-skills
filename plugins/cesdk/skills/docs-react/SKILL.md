...
name: docs-react
description: |
  Look up CE.SDK React reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for React — configuration, UI customization,
  ...
  an existing React documentation page or guide.
  ...
  <example>
  Context: User wants to export designs
  user: "How do I export a scene as PDF in my React app?"
  assistant: "I'll use /cesdk:docs-react to look that up."
  </example>
