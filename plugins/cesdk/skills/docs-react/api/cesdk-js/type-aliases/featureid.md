...
type FeatureId = 
  ...
  | "ly.img.page.move"
  | "ly.img.page.move.up"
  | "ly.img.page.move.down"
  | "ly.img.page.add"
  | "ly.img.page.resize"
  | "ly.img.page.settings"
  | "ly.img.page.bleedMargin"
  | "ly.img.page.bleedColor"
  | "ly.img.page.printMarks"
  | "ly.img.page.printMarks.crop"
  | "ly.img.page.printMarks.registration"
  | "ly.img.page.clipContent"
  | "ly.img.page.printMarks"
  | "ly.img.page.printMarks.exclusionArea"
  | "ly.img.page.printMarks.safetyMargin"
  | "ly.img.scene.layout"
