...
**Navigation:** [Guides](./guides.md) > [AI Features](./user-interface/ai-integration.md) > [Video Generation](./user-interface/ai-integration/video-generation.md) > [Plugins](./plugins.md) > [AI Video Generation](./user-interface/ai-integration/video-generation.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.84.0-nightly.20260922/examples/guides-user-interface-ai-integration-video-generation-browser/index.html)
