...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.81.0-rc.1/examples/guides-user-interface-customization-quick-start-add-dock-buttons-browser/index.html)
