...
name: docs-svelte
description: |
  Look up CE.SDK Svelte reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Svelte — configuration, UI customization,
  ...
  an existing Svelte documentation page or guide.
  ...
  <example>
  Context: User wants to customize the toolbar
  user: "How do I hide toolbar buttons in my Svelte CE.SDK editor?"
  assistant: "I'll use /cesdk:docs-svelte to look that up."
  </example>
