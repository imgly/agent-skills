...
## Key Capabilities of the Svelte Video Editor SDK
...
<CapabilityGrid
  ...
  },
  {
    ...
    description:
      'Programmatically edit videos within your Svelte application.',
    imageId: 'headless',
  },
  {
    title: 'Extendible',
...
If you're ready to start integrating CE.SDK into your Svelte application, check out the CE.SDK [Getting Started guide](./get-started/overview.md).
...
If you're ready to start integrating CE.SDK into your Svelte application, check out our [Getting Started guide](./get-started/overview.md) or explore the [Essential Guides](./guides.md).
...
## Customizing the Svelte Video Editor
...
- <Link id="5e6197">Custom Asset Sources</Link>: Serve custom video
...
<Link id="9dfcf7">**Background Removal**</Link>: Adds a button to the
canvas menu to remove image backgrounds.
<Link id="2b4c7f">**Vectorizer**</Link>: Adds a button to the canvas
