...
A 3D product configurator for your Svelte app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Mockup Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the 3D Mockup Editor component in your application:
