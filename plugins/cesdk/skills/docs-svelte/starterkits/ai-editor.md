...
AI-powered creative editing for your Svelte app—generate images, videos, audio,
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the AI Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
