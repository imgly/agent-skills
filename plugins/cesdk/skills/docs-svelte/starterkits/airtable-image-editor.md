...
Airtable image integration for your Svelte app—browse and search images from your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Airtable Image Editor integration.
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/AirtableImageEditor.svelte`):
    ...
    ```svelte
    <script>
      import AirtableImageEditor from './AirtableImageEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Airtable Image Editor into an existing Svelte application.
