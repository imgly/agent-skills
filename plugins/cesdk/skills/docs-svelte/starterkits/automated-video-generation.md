...
Generate dynamic videos from reusable templates — right inside your Svelte app. The Automated Video Generator is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline video content creation at scale.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Video Generation into an existing Svelte application. This adds the editor configuration to your current project structure.
