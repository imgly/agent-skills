...
AI-powered background removal for your Svelte app—remove backgrounds from images with a single click. Runs entirely in the browser with no server dependencies.
