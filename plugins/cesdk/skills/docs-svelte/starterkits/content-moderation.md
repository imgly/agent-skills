...
Content moderation for your Svelte app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Content Moderation Editor component in your application:
