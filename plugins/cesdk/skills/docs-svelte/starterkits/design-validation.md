...
Design validation for your Svelte app—ensure designs meet requirements before export. Detect elements outside page bounds, protruding elements, hidden text, and low-resolution images. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Validation Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Design Validation Editor component in your application:
