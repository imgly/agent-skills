...
Server-side video export for your Svelte app—export videos with GPU-accelerated
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Export Using Renderer integration.
    ...
    Import and use the Export Using Renderer component in your application:
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing Svelte application. This adds the editor configuration to your current project structure.
