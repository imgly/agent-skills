...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Form-Based Template Adoption into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Form-Based Template Adoption component in your application:
