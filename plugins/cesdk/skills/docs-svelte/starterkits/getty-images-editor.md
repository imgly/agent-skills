...
Getty Images stock photo integration for your Svelte app—search and browse millions of premium stock photos from Getty Images directly within your editor. Requires a proxy server for authentication.
...
- **Getty Images Proxy Server** – Set up a proxy server for Getty Images API access
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Getty Images Editor integration.
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/GettyImagesEditor.svelte`):
    ...
    <script>
      ...
      const GETTY_PROXY_URL = 'https://your-proxy-server.com/getty';
    ...
    ```svelte
    <script>
      import GettyImagesEditor from './GettyImagesEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Getty Images Editor into an existing Svelte application.
...
> **Proxy Server Required:** Getty Images integration requires a proxy server for API access. Set your proxy server URL via the `VITE_GETTY_IMAGES_PROXY_URL` environment variable or pass it to `initGettyImagesEditor()`.
...
<CapabilityGrid
  ...
  },
  {
    ...
    description:
      'Getty Images authentication is handled through a secure proxy server, protecting your credentials.',
    imageId: 'client-side',
  },
  {
...
- **Check your proxy server**: Ensure your proxy server is running and accessible at the configured URL
- **Check network requests**: Open DevTools Network tab and verify requests to your proxy server are succeeding
- **Verify proxy configuration**: Confirm the proxy server is correctly configured to access Getty Images API
