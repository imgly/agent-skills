...
Import and edit Adobe InDesign files in your Svelte app. Convert IDML templates to editable designs with full layout preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the InDesign Template Import into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the InDesign Template Import component in your application:
