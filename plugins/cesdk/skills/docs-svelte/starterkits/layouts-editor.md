...
Professional layout-based editing for your Svelte app—create graphics, templates, and
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Layouts Editor integration.
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/LayoutsEditor.svelte`):
    ...
    Import and use the Layouts Editor component in your application:

    ```svelte
    <script>
      import LayoutsEditor from './LayoutsEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
