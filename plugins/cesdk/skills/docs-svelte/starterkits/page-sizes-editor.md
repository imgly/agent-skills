...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Page Sizes Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-page-sizes-asset-source-ts-web/src/imgly ./src/imgly
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/PageSizesEditor.svelte`):
    ...
    Import and use the Page Sizes Editor component in your application:

    ```svelte
    <script>
      import PageSizesEditor from './PageSizesEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
