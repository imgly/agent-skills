...
Pexels stock photo integration for your Svelte app—search and browse millions of free stock photos from Pexels directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Pexels Image Editor integration.
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/PexelsImageEditor.svelte`):
    ...
    ```svelte
    <script>
      import PexelsImageEditor from './PexelsImageEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing Svelte application.
