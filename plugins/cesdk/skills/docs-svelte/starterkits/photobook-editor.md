...
This guide assumes basic familiarity with Svelte and TypeScript.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Photobook Editor project. This creates a complete, ready-to-run Svelte application with a start screen, an editor, and an export pipeline.
    ...
    ```svelte title="src/PhotobookEditor.svelte"
    <script lang="ts">
    ...
    <script lang="ts">
      import PhotobookEditor from './PhotobookEditor.svelte';
    </script>
