...
Lightweight video playback for your Svelte app—play, pause, and navigate video
...
>
> - [Open in StackBlitz](https://stackblitz.com/~/github.com/imgly/starterkit-video-player-ts-web/tree/release-$UBQ_VERSION$)
>
> - [Live demo](https://img.ly/examples/starterkit-video-player/)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Player into an existing Svelte application. This adds the player configuration to your current project structure.
