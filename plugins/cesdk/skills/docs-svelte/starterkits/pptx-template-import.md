...
Import and edit PowerPoint files in your Svelte app. Convert PPTX presentations to editable designs with full slide preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PowerPoint Template Import into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the PowerPoint Template Import component in your application:
