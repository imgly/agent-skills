...
Import and edit Adobe Photoshop files in your Svelte app. Convert PSD templates to editable designs with full layer preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Photoshop Template Import into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Photoshop Template Import component in your application:
