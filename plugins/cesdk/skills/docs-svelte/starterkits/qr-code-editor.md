...
QR code generation for your Svelte app—create customizable QR codes with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with QR Code Editor integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the QR Code Editor into an existing Svelte application.
