...
Launch CE.SDK with an image as the starting point—build photo editors, image enhancement tools, and image-first design workflows. Uses the `createFromImage()` API to open directly into editing mode.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start With Image into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Start With Image component in your application:
