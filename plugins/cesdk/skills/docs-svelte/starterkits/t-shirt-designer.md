...
Customize t-shirts with front and back print areas in your Svelte app. Includes 10 color options, size selection, quantity controls, and e-commerce cart integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the T-Shirt Designer into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the T-Shirt Designer component in your application:
