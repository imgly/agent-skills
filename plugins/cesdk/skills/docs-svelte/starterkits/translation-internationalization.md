...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Translation the Design Editor Internationalization into an existing Svelte application. This adds the editor configuration to your current project structure.
    ...
    Import and use the Translation the Design Editor Internationalization component in your application:
