...
Design editor with integrated Unsplash image library for your Svelte app. Search and use millions of free high-quality photos with automatic photographer attribution.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Unsplash Editor integration.
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/UnsplashEditor.svelte`):
    ...
    Import and use the Unsplash Editor component in your application:

    ```svelte
    <script>
      import UnsplashEditor from './UnsplashEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Unsplash Editor into an existing Svelte application. This adds the editor configuration to your current project structure.
