...
Image vectorization for your Svelte app—create customizable Image vectorizations with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Svelte application with Vectorizer Editor integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Vectorizer Editor into an existing Svelte application.
