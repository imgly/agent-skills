...
Integrate the Video Animations into your Svelte application using the imperative API.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```svelte
    <script>
      import VideoAnimationsEditor from './components/VideoAnimationsEditor.svelte';
    </script>
