...
AI-powered video captioning for your Svelte app—auto-generate captions with ElevenLabs Scribe V2, import SRT files, or edit existing captions with professional styling controls. Runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Captions into an existing Svelte application. This adds the editor configuration to your current project structure.
