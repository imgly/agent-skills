...
Integrate the Video Export Options into your Svelte application using the imperative API.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    ```svelte
    <script>
      import VideoExportOptionsEditor from './components/VideoExportOptionsEditor.svelte';
    </script>
