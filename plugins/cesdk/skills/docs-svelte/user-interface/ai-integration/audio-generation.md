...
**Navigation:** [Guides](./guides.md) > [AI Features](./user-interface/ai-integration.md) > [Audio Generation](./user-interface/ai-integration/audio-generation.md) > [Plugins](./plugins.md) > [AI Audio Generation](./user-interface/ai-integration/audio-generation.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.84.0-nightly.20260922/examples/guides-user-interface-ai-integration-audio-generation-browser/index.html)
