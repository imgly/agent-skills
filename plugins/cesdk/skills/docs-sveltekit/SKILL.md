...
name: docs-sveltekit
description: |
  Look up CE.SDK SvelteKit reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for SvelteKit — configuration, UI customization,
  export options, feature guides, or getting-started instructions. Also use when the
  user mentions "IMG.LY", "CreativeEditor", "CE.SDK", or "cesdk" and needs to find
  an existing SvelteKit documentation page or guide.
