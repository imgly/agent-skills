...
**Navigation:** [Guides](./guides.md) > [Import Media Assets](./import-media.md) > [Asset Library](./import-media/asset-library.md) > [Basics](./import-media/asset-library/basics.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.83.0-nightly.20260830/examples/guides-import-media-asset-library-basics-browser/index.html)
...
For display properties like `gridColumns` and `previewLength`, see the [Thumbnails](./import-media/asset-library/thumbnails.md) guide.
...
- [Customize](./import-media/asset-library/customize.md) — Icons, i18n, replace libraries
- [Thumbnails](./import-media/asset-library/thumbnails.md) — Thumbnail URIs, display settings
- [Refresh Assets](./import-media/asset-library/refresh-assets.md) — Trigger asset reloads
