...
A 3D product configurator for your SvelteKit app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Mockup Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-3d-product-preview-react-web.git
        cp -r starterkit-3d-product-preview-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-3d-product-preview-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-3d-product-preview-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the 3D Mockup Editor component in your page route (e.g., `src/routes/+page.svelte`):
...
```typescript title="src/lib/imgly/mockup.ts"
