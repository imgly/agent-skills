...
AI-powered creative editing for your SvelteKit app—generate images, videos, audio,
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the AI Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-ai-editor-react-web.git
        cp -r starterkit-ai-editor-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-ai-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-ai-editor-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
...
```typescript title="src/lib/imgly/plugins/ai-app/ai-providers.ts"
...
```typescript title="src/lib/imgly/config/index.ts"
...
```typescript title="src/lib/imgly/config/design-editor/plugin.ts"
import {
  FiltersAssetSource,
  StickerAssetSource,
  TextAssetSource,
...
```typescript title="src/lib/imgly/config/design-editor/actions.ts"
...
```typescript title="src/lib/imgly/config/design-editor/settings.ts"
...
```typescript title="src/lib/imgly/config/design-editor/i18n.ts"
...
```typescript title="src/lib/imgly/config/design-editor/features.ts"
...
```typescript title="src/lib/imgly/plugins/ai-app/ai-apps.ts"
...
```typescript title="src/lib/imgly/plugins/background-removal.ts"
