...
Airtable image integration for your SvelteKit app—browse and search images from your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Airtable Image Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-airtable-asset-source-react-web/src/lib/imgly ./src/lib/imgly
        cp starterkit-airtable-asset-source-react-web/static/assets/remove-bg.png ./static/assets/
        rm -rf starterkit-airtable-asset-source-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-airtable-asset-source-react-web/src/lib/imgly ./src/lib/imgly
        npx degit imgly/starterkit-airtable-asset-source-react-web/static/assets ./static/assets
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/AirtableImageEditor.svelte`):
    ...
    <script>
      ...
      let AirtableImageEditor;

      onMount(async () => {
        const module = await import('$lib/AirtableImageEditor.svelte');
        AirtableImageEditor = module.default;
      });
    </script>

    {#if browser && AirtableImageEditor}
      <svelte:component this={AirtableImageEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import AirtableImageEditor from '$lib/AirtableImageEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Airtable Image Editor into an existing SvelteKit application.
    ...
    Use dynamic imports or disable SSR as shown in the New Project section.
  </TabItem>
</Tabs>
...
CE.SDK requires browser APIs and cannot run during server-side rendering. Use dynamic imports or disable SSR for the page.
