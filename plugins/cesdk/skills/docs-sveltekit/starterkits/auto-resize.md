...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Resizing into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automated-resizing-react-web.git
        cp -r starterkit-automated-resizing-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-automated-resizing-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automated-resizing-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
...
```tsx title="src/lib/imgly/index.ts"
...
```tsx title="src/lib/imgly/constants.ts"
{
  id: 'ig-story',
...
```tsx title="src/lib/imgly/resizing.ts"
...
```tsx title="src/lib/imgly/config/settings.ts"
...
```tsx title="src/lib/imgly/config/i18n.ts"
...
```tsx title="src/lib/imgly/config/ui/navigationBar.ts"
...
```tsx title="src/lib/imgly/config/features.ts"
