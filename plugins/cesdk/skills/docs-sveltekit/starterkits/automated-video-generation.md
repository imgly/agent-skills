...
Generate dynamic videos from reusable templates — right inside your SvelteKit app. The Automated Video Generator is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline video content creation at scale.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-placeholders-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
