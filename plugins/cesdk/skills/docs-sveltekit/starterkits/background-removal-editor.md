...
AI-powered background removal for your SvelteKit app—remove backgrounds from images with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-background-removal-editor-ts-web/src/lib/imgly ./src/lib/imgly
        npx degit imgly/starterkit-background-removal-editor-ts-web/static/assets ./static/assets
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Background Removal Editor into an existing SvelteKit application.
