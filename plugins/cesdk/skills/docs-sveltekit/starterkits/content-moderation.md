...
Content moderation for your SvelteKit app—automatically validate designs against content policies. Detect inappropriate content including weapons, alcohol, drugs, and nudity. Runs entirely in the browser with optional backend API integration.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-content-moderation-react-web.git
        cp -r starterkit-content-moderation-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-content-moderation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-content-moderation-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Content Moderation Editor component in your page route (e.g., `src/routes/+page.svelte`):
...
```typescript title="src/lib/imgly/utils.ts"
import type { CreativeEngine } from '@cesdk/cesdk-js';
