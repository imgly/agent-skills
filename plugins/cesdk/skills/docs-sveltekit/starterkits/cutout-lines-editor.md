...
Print-ready cutout line creation for your SvelteKit app—create customizable cutout lines with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Cutout Lines Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-cutout-lines-editor-ts-web/src/imgly ./src/lib/imgly
        rm -rf starterkit-cutout-lines-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-cutout-lines-editor-ts-web/src/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <script lang="ts">
      ...
      import { initCutoutLinesEditor } from '$lib/imgly';
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Cutout Lines Editor into an existing SvelteKit application.
