...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Data Merge into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-batch-image-generation-react-web.git
        cp -r starterkit-batch-image-generation-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-batch-image-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-batch-image-generation-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
...
```typescript title="src/lib/imgly/batch-renderer.ts"
