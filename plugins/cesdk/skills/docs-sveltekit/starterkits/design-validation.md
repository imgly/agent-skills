...
Design validation for your SvelteKit app—ensure designs meet requirements before export. Detect elements outside page bounds, protruding elements, hidden text, and low-resolution images. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Validation Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-design-validation-react-web.git
        cp -r starterkit-design-validation-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-design-validation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-design-validation-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Design Validation Editor component in your page route (e.g., `src/routes/+page.svelte`):
...
```typescript title="src/lib/imgly/validation.ts"
...
```typescript title="src/lib/imgly/types.ts"
