...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Options Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-export-options-ts-web.git
        cp -r starterkit-export-options-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-options-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Export Options Editor component in your page route (e.g., `src/routes/+page.svelte`):
...
```typescript title="src/lib/imgly/plugins/export-design-panel.ts"
