...
Server-side video export for your SvelteKit app—export videos with GPU-accelerated
rendering. Uses the CE.SDK Renderer API for server-side
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Export Using Renderer integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-export-using-renderer-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-export-using-renderer-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-using-renderer-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Export Using Renderer component in your page route (e.g., `src/routes/+page.svelte`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing SvelteKit application. This adds the editor configuration to your current project structure.
