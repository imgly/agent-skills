...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Form-Based Template Adoption into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-form-based-template-adoption-ts-web.git
        cp -r starterkit-form-based-template-adoption-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-form-based-template-adoption-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-form-based-template-adoption-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Form-Based Template Adoption component in your page route (e.g., `src/routes/+page.svelte`):
