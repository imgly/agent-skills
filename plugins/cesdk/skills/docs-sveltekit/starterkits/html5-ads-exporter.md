...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with HTML5 Ads Exporter integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-html5-ads-exporter-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-html5-ads-exporter-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-html5-ads-exporter-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the editor component in your page route (e.g., `src/routes/+page.svelte`):
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing SvelteKit application. This adds the editor configuration to your current project structure.
