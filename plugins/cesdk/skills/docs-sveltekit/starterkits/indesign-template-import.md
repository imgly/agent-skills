...
Import and edit Adobe InDesign files in your SvelteKit app. Convert IDML templates to editable designs with full layout preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the InDesign Template Import into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-indesign-template-import-react-web.git
        cp -r starterkit-indesign-template-import-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-indesign-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-indesign-template-import-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/DesignEditor.svelte`):
    ...
    Import and use the InDesign Template Import component in your page route (e.g., `src/routes/+page.svelte`):
    ...
    <script>
      ...
      onMount(async () => {
        const module = await import('$lib/DesignEditor.svelte');
        DesignEditor = module.default;
      });
    </script>

    {#if browser && DesignEditor}
      <svelte:component this={DesignEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import DesignEditor from '$lib/DesignEditor.svelte';
    </script>
