...
Mockup rendering for your SvelteKit app—render designs on product mockups in real-time. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Mockup Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-product-preview-react-web.git
        cp -r starterkit-product-preview-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-product-preview-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-product-preview-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
