...
Generate multiple on-brand image variations from a single data source — and embed the entire workflow into your SvelteKit application using CreativeEditor SDK (CE.SDK).
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Multi Image Generation into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-multi-image-generation-react-web.git
        cp -r starterkit-multi-image-generation-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-multi-image-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-multi-image-generation-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
