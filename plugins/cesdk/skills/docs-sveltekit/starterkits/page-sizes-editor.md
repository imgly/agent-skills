...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.80.0-nightly.20260720/examples/starterkit-page-sizes-asset-source/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Page Sizes Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-page-sizes-asset-source-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-page-sizes-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-page-sizes-asset-source-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/PageSizesEditor.svelte`):
    ...
    Import and use the Page Sizes Editor component in your page route (e.g., `src/routes/+page.svelte`):
    ...
    <script>
      ...
      onMount(async () => {
        const module = await import('$lib/PageSizesEditor.svelte');
        PageSizesEditor = module.default;
      });
    </script>

    {#if browser && PageSizesEditor}
      <svelte:component this={PageSizesEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import PageSizesEditor from '$lib/PageSizesEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
