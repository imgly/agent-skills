...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PDF Template Import into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-pdf-template-import-react-web.git
        cp -r starterkit-pdf-template-import-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-pdf-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-pdf-template-import-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the PDF Template Import component in your page route (e.g., `src/routes/+page.svelte`):
