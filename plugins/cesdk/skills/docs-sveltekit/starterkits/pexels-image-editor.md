...
Pexels stock photo integration for your SvelteKit app—search and browse millions of free stock photos from Pexels directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Pexels Image Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-pexels-asset-source-ts-web/src/lib/imgly ./src/lib/imgly
        cp starterkit-pexels-asset-source-ts-web/static/assets/remove-bg.png ./static/assets/
        rm -rf starterkit-pexels-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-pexels-asset-source-ts-web/src/lib/imgly ./src/lib/imgly
        npx degit imgly/starterkit-pexels-asset-source-ts-web/static/assets ./static/assets
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/PexelsImageEditor.svelte`):
    ...
    <script>
      ...
      let PexelsImageEditor;

      onMount(async () => {
        const module = await import('$lib/PexelsImageEditor.svelte');
        PexelsImageEditor = module.default;
      });
    </script>

    {#if browser && PexelsImageEditor}
      <svelte:component this={PexelsImageEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import PexelsImageEditor from '$lib/PexelsImageEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing SvelteKit application.
