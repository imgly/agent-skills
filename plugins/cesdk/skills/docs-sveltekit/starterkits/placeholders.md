...
Create reusable design templates with placeholder zones — right inside your SvelteKit app. The Design Placeholders Editor is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline template-based design creation at scale.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Placeholders Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-placeholders-react-web.git
        cp -r starterkit-placeholders-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-placeholders-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-placeholders-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
