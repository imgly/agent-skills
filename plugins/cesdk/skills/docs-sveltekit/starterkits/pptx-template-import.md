...
Import and edit PowerPoint files in your SvelteKit app. Convert PPTX presentations to editable designs with full slide preservation. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PowerPoint Template Import into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-pptx-template-import-react-web.git
        cp -r starterkit-pptx-template-import-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-pptx-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-pptx-template-import-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the PowerPoint Template Import component in your page route (e.g., `src/routes/+page.svelte`):
