...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-print-ready-pdf-editor-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-print-ready-pdf-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-print-ready-pdf-editor-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Print-Ready PDF Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
...
To include bleed, the starter kit sets the page margin properties (`page/margin/top`, `page/margin/bottom`, `page/margin/left`, `page/margin/right` and `page/marginEnabled`) on each page before exporting — see `src/lib/imgly/plugins/export-print-ready-pdf.ts` for the full implementation.
