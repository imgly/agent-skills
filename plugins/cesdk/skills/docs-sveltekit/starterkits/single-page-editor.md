...
Single-page design editing for your SvelteKit app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Single Page Editor into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-single-page-editor-ts-web.git
        cp -r starterkit-single-page-editor-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-single-page-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-single-page-editor-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Single Page Editor component in your page route (e.g., `src/routes/+page.svelte`):
