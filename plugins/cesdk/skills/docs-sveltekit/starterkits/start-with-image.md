...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start With Image into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-image-react-web.git
        cp -r starterkit-start-with-image-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-start-with-image-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-image-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Start With Image component in your page route (e.g., `src/routes/+page.svelte`):
