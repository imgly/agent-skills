...
Professional video editing for your SvelteKit app—edit clips, add effects, trim footage, and export to MP4. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start with Video into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-video-react-web.git
        cp -r starterkit-start-with-video-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-start-with-video-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-video-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Start with Video component in your page route (e.g., `src/routes/+page.svelte`):
