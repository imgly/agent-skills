...
Image vectorization for your SvelteKit app—create customizable Image vectorizations with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new SvelteKit application with Vectorizer Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-vectorizer-editor-ts-web/src/imgly ./src/lib/imgly
        rm -rf starterkit-vectorizer-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-vectorizer-editor-ts-web/src/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create `src/lib/VectorizerEditor.svelte`:
    ...
    <script lang="ts">
      ...
      import { initVectorizerEditor } from '$lib/imgly';
    ...
    ```svelte
    <script lang="ts">
      import VectorizerEditor from '$lib/VectorizerEditor.svelte';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Vectorizer Editor into an existing SvelteKit application.
