...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Version History into an existing SvelteKit application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-version-history-react-web.git
        cp -r starterkit-version-history-react-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-version-history-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-version-history-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Import and use the Version History component in your page route (e.g., `src/routes/+page.svelte`):
...
```typescript title="src/lib/imgly/history.ts"
