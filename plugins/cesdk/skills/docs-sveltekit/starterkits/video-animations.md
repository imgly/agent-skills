...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.80.0-nightly.20260724/examples/starterkit-video-animations/index.html)
...
Integrate the Video Animations into your SvelteKit application using the imperative API.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-animations-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-video-animations-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-animations-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/VideoAnimationsEditor.svelte`):
    ...
    <script>
      ...
      onMount(async () => {
        if (browser) {
          ...
          const { initVideoAnimationsEditor } = await import('$lib/imgly');
    ...
    Import and use the Video Animations component in your page route:
    ...
    <script>
      ...
      let VideoAnimationsEditor;

      onMount(async () => {
        const module = await import('$lib/VideoAnimationsEditor.svelte');
        VideoAnimationsEditor = module.default;
      });
    </script>

    {#if browser && VideoAnimationsEditor}
      <svelte:component this={VideoAnimationsEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import VideoAnimationsEditor from '$lib/VideoAnimationsEditor.svelte';
    </script>
