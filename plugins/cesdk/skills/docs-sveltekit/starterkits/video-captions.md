...
AI-powered video captioning for your SvelteKit app—auto-generate captions with ElevenLabs Scribe V2, import SRT files, or edit existing captions with professional styling controls. Runs entirely in the browser.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-captions-react-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
