...
Integrate the Video Export Options into your SvelteKit application using the imperative API.
  ...
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-export-options-ts-web/src/lib/imgly ./src/lib/imgly
        rm -rf starterkit-video-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-export-options-ts-web/src/lib/imgly ./src/lib/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Svelte component using the CE.SDK imperative API (e.g., `src/lib/VideoExportOptionsEditor.svelte`):
    ...
    <script>
      ...
      onMount(async () => {
        if (browser) {
          ...
          const { initVideoExportOptionsEditor } = await import('$lib/imgly');
    ...
    Import and use the Video Export Options component in your page route:
    ...
    <script>
      ...
      let VideoExportOptionsEditor;

      onMount(async () => {
        const module = await import('$lib/VideoExportOptionsEditor.svelte');
        VideoExportOptionsEditor = module.default;
      });
    </script>

    {#if browser && VideoExportOptionsEditor}
      <svelte:component this={VideoExportOptionsEditor} />
    {/if}
    ```
    ...
    ```svelte
    <script>
      import VideoExportOptionsEditor from '$lib/VideoExportOptionsEditor.svelte';
    </script>
