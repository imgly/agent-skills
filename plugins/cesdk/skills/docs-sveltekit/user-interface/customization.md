...
- [Drag & Drop](./user-interface/customization/drag-and-drop.md) - Turn on the drag-to-swap gesture, drag assets from your own UI onto the canvas, change what a drop does, and place an asset yourself in the CE.SDK web editor.
...
- [Customize the Clip Context Menu](./sveltekit.md) - Control which actions appear in the video timeline clip context menu, reorder built-in actions, and add custom entries per clip type.
...
- [Loading Indicator](./sveltekit.md) - Customize the loading screen that appears while the CE.SDK editor initializes by adding headings, body text, or removing the spinner.
