...
name: docs-vue
description: |
  Look up CE.SDK Vue.js reference guides and documentation pages.

  Use when the user needs CE.SDK reference docs for Vue.js — configuration, UI customization,
  ...
  an existing Vue.js documentation page or guide.
  ...
  <example>
  Context: User wants to add filters
  user: "How do I apply image filters with CE.SDK in Vue?"
  assistant: "I'll use /cesdk:docs-vue to look that up."
  </example>
