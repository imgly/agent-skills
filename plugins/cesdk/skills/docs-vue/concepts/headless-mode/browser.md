...
- Framework-specific headless quick starts for [React](#broken-link-h1f42n), [Next.js](#broken-link-k4f45q), [Vue](./get-started/new-project-without-ui.md), and [Angular](#broken-link-c1234j).
