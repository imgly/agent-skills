...
| `defaultEmojiFontFileUri`                          | `String` | `"https://cdn.img.ly/assets/v5/emoji/NotoColorEmoji.ttf"`     | URI of default font file for emojis.                                                                                                                                                                                                                |
...
| `placeholderControls/showButton`                   | `Bool`   | `true`                                                        | Show the placeholder toggle in the Inspector panel.                                                                                                                                                                                                 |
...
| `touch/pinchAction`                                | `Enum`   | `"Scale"`                                                     | The action to perform when a pinch gesture is performed. Possible values: `"None"`, `"Zoom"`, `"Scale"`, `"Auto"`                                                                                                                                            |
