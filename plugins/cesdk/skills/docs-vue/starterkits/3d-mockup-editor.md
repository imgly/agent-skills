...
A 3D product configurator for your web app—design and preview products in real-time on interactive 3D models. Built with React and Google Model Viewer, runs entirely in the browser.

![3D Product Configurator starter kit showing a 3D product preview interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-3d-product-preview-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the 3D Product Configurator into an existing React application. This adds the editor configuration to your current project structure.
    ...
    Add the 3D model viewer and its dependencies:
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="pnpm">
        pnpm add @google/model-viewer three
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn add @google/model-viewer three
      </TerminalTab>
    </TerminalTabs>

    The 3D product configurator uses these key libraries:
    ...
    - `@google/model-viewer` -- Web component for displaying interactive 3D models
    - `three` -- 3D graphics library (required peer dependency of `@google/model-viewer`)
