...
AI-powered creative editing for your web app—generate images, videos, audio,
...
![AI Editor starter kit showing an AI-powered creative editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    > **Remove Other Configs:** After choosing your mode, you can delete the unused configuration folders (e.g., if using Photo mode, delete `config/design-editor/` and `config/video-editor/`).
  </TabItem>
</Tabs>
