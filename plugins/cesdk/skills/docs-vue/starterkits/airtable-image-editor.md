...
Airtable image integration for your Vue app—browse and search images from your Airtable database directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Airtable Image Editor integration.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        ...
        npx degit imgly/starterkit-airtable-asset-source-react-web/public/assets ./public/assets
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `AirtableImageEditor.vue`):
    ...
    <script setup lang="ts">
    import AirtableImageEditor from './components/AirtableImageEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Airtable Image Editor into an existing Vue application. This adds the editor configuration to your current project structure.
...
> **API Key Required:** To use Airtable in production, you need an API key from your [Airtable account settings](https://support.airtable.com/docs/creating-and-using-api-keys-and-access-tokens).
> Set it via the `VITE_AIRTABLE_API_KEY` environment variable or pass it to `initAirtableImageEditor()`.
...
- [Asset Source Plugins](./plugins/asset-sources.md) – Custom asset source configuration
