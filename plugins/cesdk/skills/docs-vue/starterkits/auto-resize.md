...
![Automated Resizing starter kit showing multiple social media format outputs](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-automated-resizing-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automated Resizing functionality into an existing React application. This adds the resizing configuration and components to your current project structure.
    ...
    The `imgly/` folder contains the resizing configuration:
