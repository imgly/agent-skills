...
Print-ready cutout line creation for your Vue app—create customizable cutout lines with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Cutout Lines Editor integration.
    ...
    Create `src/components/CutoutLinesEditor.vue`:
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Cutout Lines Editor into an existing Vue application.
