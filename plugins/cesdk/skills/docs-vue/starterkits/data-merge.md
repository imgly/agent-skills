...
![Data Merge starter kit showing personalized employee cards generated from template](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Data Merge functionality into an existing React web application. This adds the editor and batch rendering configuration to your current project structure.
    ...
    The `imgly/` folder contains the editor and batch rendering configuration:
    ...
    Install the required packages for the editor and batch rendering:
    ...
    ### Headless Engine (for Batch Rendering)
