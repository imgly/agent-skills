...
Server-side video export for your Vue app—export videos with GPU-accelerated rendering. Uses the CE.SDK Renderer API for server-side processing with progress tracking.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Export Using Renderer integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing Vue application. This adds the editor configuration to your current project structure.
