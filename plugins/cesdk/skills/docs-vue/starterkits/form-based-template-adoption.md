...
Create form-driven design experiences where users fill out simple forms to customize templates. Real-time preview updates as users input data for seamless template adoption.

![Form-Based Template Adoption starter kit showing the form inputs and design preview](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-form-based-template-adoption-ts-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Form-Based Template Adoption editor into an existing web application. This adds the editor configuration to your current project structure.
