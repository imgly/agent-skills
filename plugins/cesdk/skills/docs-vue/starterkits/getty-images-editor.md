...
Design editor with integrated Getty Images library for your Vue app. Search and use millions of premium high-quality stock photos with proper licensing and attribution.

![Getty Images Editor starter kit showing a design interface with Getty Images photos](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <script setup lang="ts">
    import GettyImagesEditor from './components/GettyImagesEditor.vue';
    </script>
    ```
  </TabItem>
...
```typescript title="src/imgly/index.ts"
// Add Getty Images library integration
...
> **Complete Proxy Example:** See `api/getty-images-proxy-example.ts` in the starter kit for a full implementation with CORS handling, error management, and rate limit header forwarding.
...
cesdk.i18n.setTranslations({
  en: {
    'libraries.gettyImages.label': 'Getty Images',
