...
Professional layout-based editing for your Vue app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Layouts Editor integration.
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `LayoutsEditor.vue`):
    ...
    <script setup lang="ts">
    import LayoutsEditor from './components/LayoutsEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Vue application. This adds the editor configuration to your current project structure.
