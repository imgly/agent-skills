...
Mockup rendering for your web app—render designs on product mockups in real-time. Runs entirely in the browser with no server dependencies.

![Mockup Editor starter kit showing a professional mockup editor interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-product-preview-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-product-preview-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Mockup Editor into an existing web application. This adds the editor configuration to your current project structure.
    ...
    The `imgly/` folder contains the editor configuration and mockup rendering logic:
    ...
    Install the Creative Editor SDK and the headless engine:

    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        npm install @cesdk/cesdk-js @cesdk/engine
      </TerminalTab>

      <TerminalTab label="pnpm">
        pnpm add @cesdk/cesdk-js @cesdk/engine
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn add @cesdk/cesdk-js @cesdk/engine
      </TerminalTab>
    </TerminalTabs>

    The mockup editor uses two engines:

    - `@cesdk/cesdk-js` -- The design editor where users edit their designs
    - `@cesdk/engine` -- A headless engine for background mockup rendering
