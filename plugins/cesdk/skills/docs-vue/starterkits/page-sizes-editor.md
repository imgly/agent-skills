...
Professional page size selection for your Vue app—create graphics, templates, and multi-page documents. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Page Sizes Editor integration.
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `PageSizesEditor.vue`):
    ...
    <script setup lang="ts">
    import PageSizesEditor from './components/PageSizesEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Vue application. This adds the editor configuration to your current project structure.
