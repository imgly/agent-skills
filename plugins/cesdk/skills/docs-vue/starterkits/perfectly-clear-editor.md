...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.83.0-nightly.20260902/examples/starterkit-perfectlyclear-editor/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Perfectly Clear Editor integration.
    ...
    Create `src/components/PerfectlyClearEditor.vue`:
    ...
    ```vue
    <script setup lang="ts">
    import PerfectlyClearEditor from './components/PerfectlyClearEditor.vue';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Perfectly Clear Editor into an existing Vue application.
