...
Pexels stock photo integration for your Vue app—search and browse millions of free stock photos from Pexels directly within your editor. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Pexels Image Editor integration.
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `PexelsImageEditor.vue`):
    ...
    <script setup lang="ts">
    import PexelsImageEditor from './components/PexelsImageEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing Vue application. This adds the editor configuration to your current project structure.
