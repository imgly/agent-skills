...
Create reusable design templates with placeholder zones — right inside your web app. The Design Placeholders Editor is a pre-built solution powered by CreativeEditor SDK (CE.SDK), designed for developers who want to streamline template-based design creation at scale.

![Design Placeholders Editor starter kit showing template placeholder interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-placeholders-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-placeholders-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Placeholders Editor into an existing web application. This adds the editor configuration to your current project structure.
    ...
    Choose your editing role and initialize the editor accordingly:
