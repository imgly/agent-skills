...
Import and edit PowerPoint files in your web app. Convert PPTX presentations to editable designs with full slide preservation. Runs entirely in the browser with no server dependencies.

![PowerPoint Template Import starter kit showing PPTX file import and editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-pptx-template-import-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-pptx-template-import-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate PowerPoint Template Import into an existing web application. This adds the editor configuration and PPTX import functionality to your current project structure.
    ...
    The `imgly/` folder contains the editor configuration and PPTX importer:
    ...
    Install the required packages for the editor and PPTX import:
    ...
    Add PowerPoint file import support:
