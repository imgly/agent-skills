...
Import and edit Adobe Photoshop files in your web app. Convert PSD templates to editable designs with full layer preservation. Runs entirely in the browser with no server dependencies.

![Photoshop Template Import starter kit showing PSD file import and editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-psd-template-import-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-psd-template-import-react-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate Photoshop Template Import into an existing web application. This adds the editor configuration and PSD import functionality to your current project structure.
    ...
    The `imgly/` folder contains the editor configuration and PSD importer:
    ...
    Install the required packages for the editor and PSD import:
