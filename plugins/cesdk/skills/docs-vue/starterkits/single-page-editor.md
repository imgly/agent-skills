...
Single-page design editing for your web app—create social media posts, business cards, and fixed-format graphics. Runs entirely in the browser with no server dependencies.

![Single Page Editor starter kit showing a professional design editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-single-page-editor-ts-web/tree/release-$UBQ_VERSION$)
>
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Single Page Editor into an existing web application. This adds the editor configuration to your current project structure.
