...
Design editor with integrated Unsplash image library for your Vue app. Search and use millions of free high-quality photos with automatic photographer attribution.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Unsplash Editor integration.
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="yarn">
        yarn create vue@latest your-project-name
        cd your-project-name
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `UnsplashEditor.vue`):
    ...
    <script setup lang="ts">
    import UnsplashEditor from './components/UnsplashEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Unsplash Editor into an existing Vue application. This adds the editor configuration to your current project structure.
