...
Image vectorization for your Vue app—create customizable Image vectorizations with a single click. Runs entirely in the browser with no server dependencies.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Vue application with Vectorizer Editor integration.
    ...
    Create `src/components/VectorizerEditor.vue`:
    ...
    ```vue
    <script setup lang="ts">
    import VectorizerEditor from './components/VectorizerEditor.vue';
    </script>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Vectorizer Editor into an existing Vue application.
    ...
    Create a Vue component for the editor as shown in the "New Project" tab above.
  </TabItem>
</Tabs>
