...
Save and restore design versions with snapshot functionality. Track changes with thumbnails and user attribution, then revert to any previous state—all running in the browser.

![Version History starter kit showing design editor with snapshot sidebar](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [View source on GitHub](https://github.com/imgly/starterkit-version-history-react-web/tree/release-$UBQ_VERSION$)
>
...
This guide assumes basic familiarity with React, JavaScript, or TypeScript.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Version History editor into an existing React application. This adds the editor configuration to your current project structure.
