...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `VideoAnimationsEditor.vue`):
    ...
    <script setup lang="ts">
    import VideoAnimationsEditor from './components/VideoAnimationsEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Animations into an existing Vue application. This adds the editor configuration to your current project structure.
