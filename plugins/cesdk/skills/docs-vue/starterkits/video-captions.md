...
AI-powered video captioning for your web app—auto-generate captions with ElevenLabs Scribe V2, import SRT files, or edit existing captions with professional styling controls. Runs entirely in the browser.

![Video Captions starter kit showing a professional video editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
