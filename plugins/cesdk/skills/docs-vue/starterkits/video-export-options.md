...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a Vue component using the official CE.SDK Vue wrapper (e.g., `VideoExportOptionsEditor.vue`):
    ...
    ```vue
    <template>
      <VideoExportOptionsEditor />
    </template>

    <script setup lang="ts">
    import VideoExportOptionsEditor from './components/VideoExportOptionsEditor.vue';
    </script>
    ```
  </TabItem>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Video Export Options into an existing Vue application. This adds the editor configuration to your current project structure.
