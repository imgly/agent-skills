...
v1.82 also ships the bundled typefaces as WOFF2 instead of TTF and OTF. Most integrations need no
changes, but a scene that stores a font path into the asset bundle you serve needs a one-time
migration. See [To v1.82 (Fonts)](./to-v1-82-fonts.md).
